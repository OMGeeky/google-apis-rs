...
///              .relationship_status(&AdvertiserRelationshipStatusEnum::Approved)
///              .page_token("ea")
...
///              .projection(&CcOfferProjectionEnum::Full)
///              .add_advertiser("no")
///              .doit().await;
/// # }
/// ```
...
///              .charge_type(&EventChargeTypeEnum::Credit)
///              .advertiser_id("amet.")
///              .doit().await;
/// # }
/// ```
...
///              .relationship_status(&PublisherRelationshipStatusEnum::Approved)
...
///              .max_results(92)
///              .add_link_id("dolores")
///              .event_type(&ReportEventTypeEnum::Action)
///              .end_date("gubergren")
