...
pub struct AppAuthorizedCertificateCreateCall<'a, S>
   ...
   pub(super) _request: AuthorizedCertificate,
...
///              .override_strategy(&AppOverrideStrategyEnum::UNSPECIFIEDDOMAINOVERRIDESTRATEGY)
///              .doit().await;
/// # }
/// ```
...
pub struct AppDomainMappingDeleteCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _apps_id: String,
   pub(super) _domain_mappings_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AppFirewallIngressRuleBatchUpdateCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _request: BatchUpdateIngressRulesRequest,
   pub(super) _apps_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct AppFirewallIngressRuleCreateCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _request: FirewallRule,
   pub(super) _apps_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct AppFirewallIngressRuleDeleteCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _apps_id: String,
   pub(super) _ingress_rules_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AppFirewallIngressRuleListCall<'a, S>
   ...
   pub(super) _page_token: Option<String>,
   pub(super) _page_size: Option<i32>,
   pub(super) _matching_address: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
///              .include_extra_data(&AppIncludeExtraDataEnum::INCLUDEEXTRADATAUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
pub struct AppGetCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _apps_id: String,
   pub(super) _include_extra_data: Option<AppIncludeExtraDataEnum>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub fn include_extra_data(mut self, new_value: &AppIncludeExtraDataEnum) -> AppGetCall<'a, S> {
        self._include_extra_data = Some(new_value.clone());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    /// while executing the actual API request.
...
///              .environment(&AppEnvironmentEnum::ENVIRONMENTUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
pub struct AppListRuntimeCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _apps_id: String,
   pub(super) _environment: Option<AppEnvironmentEnum>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub fn environment(mut self, new_value: &AppEnvironmentEnum) -> AppListRuntimeCall<'a, S> {
        self._environment = Some(new_value.clone());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    /// while executing the actual API request.
...
pub struct AppRepairCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _request: RepairApplicationRequest,
   pub(super) _apps_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationApplicationAuthorizedDomainListCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _projects_id: String,
   pub(super) _locations_id: String,
   pub(super) _applications_id: String,
   pub(super) _page_token: Option<String>,
   pub(super) _page_size: Option<i32>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
