...
///              .view(&FolderViewEnum::FULL)
///              .secondary_aggregation_per_series_aligner(&FolderSecondaryAggregationPerSeriesAlignerEnum::ALIGNNONE)
///              .add_secondary_aggregation_group_by_fields("gubergren")
///              .secondary_aggregation_cross_series_reducer(&FolderSecondaryAggregationCrossSeriesReducerEnum::REDUCENONE)
...
///              .filter("ea")
///              .aggregation_per_series_aligner(&FolderAggregationPerSeriesAlignerEnum::ALIGNNONE)
///              .add_aggregation_group_by_fields("ipsum")
///              .aggregation_cross_series_reducer(&FolderAggregationCrossSeriesReducerEnum::REDUCENONE)
...
///              .view(&OrganizationViewEnum::FULL)
///              .secondary_aggregation_per_series_aligner(&OrganizationSecondaryAggregationPerSeriesAlignerEnum::ALIGNNONE)
///              .add_secondary_aggregation_group_by_fields("duo")
///              .secondary_aggregation_cross_series_reducer(&OrganizationSecondaryAggregationCrossSeriesReducerEnum::REDUCENONE)
...
///              .interval_end_time(chrono::Utc::now())
///              .filter("rebum.")
///              .aggregation_per_series_aligner(&OrganizationAggregationPerSeriesAlignerEnum::ALIGNNONE)
///              .add_aggregation_group_by_fields("est")
///              .aggregation_cross_series_reducer(&OrganizationAggregationCrossSeriesReducerEnum::REDUCENONE)
...
///              .view(&ProjectViewEnum::FULL)
///              .secondary_aggregation_per_series_aligner(&ProjectSecondaryAggregationPerSeriesAlignerEnum::ALIGNNONE)
///              .add_secondary_aggregation_group_by_fields("Lorem")
///              .secondary_aggregation_cross_series_reducer(&ProjectSecondaryAggregationCrossSeriesReducerEnum::REDUCENONE)
...
///              .interval_end_time(chrono::Utc::now())
///              .filter("sed")
///              .aggregation_per_series_aligner(&ProjectAggregationPerSeriesAlignerEnum::ALIGNNONE)
///              .add_aggregation_group_by_fields("sit")
///              .aggregation_cross_series_reducer(&ProjectAggregationCrossSeriesReducerEnum::REDUCENONE)
