...
pub struct CustomerAppFetchDevicesRequestingExtensionCall<'a, S>
   ...
   pub(super) _page_size: Option<i32>,
   pub(super) _org_unit_id: Option<String>,
   pub(super) _extension_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct CustomerReportCountPrintJobsByPrinterCall<'a, S>
   ...
   pub(super) hub: &'a ChromeManagement<S>,
   pub(super) _customer: String,
   pub(super) _printer_org_unit_id: Option<String>,
   pub(super) _page_token: Option<String>,
   pub(super) _page_size: Option<i32>,
   pub(super) _order_by: Option<String>,
   pub(super) _filter: Option<String>,
...
///              .order_by("Stet")
///              .filter("vero")
///              .app_type(&CustomerAppTypeEnum::APPTYPEUNSPECIFIED)
///              .app_id("elitr")
///              .doit().await;
/// # }
/// ```
...
pub struct CustomerTelemetryNotificationConfigCreateCall<'a, S>
   ...
   pub(super) hub: &'a ChromeManagement<S>,
   pub(super) _request: GoogleChromeManagementV1TelemetryNotificationConfig,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
