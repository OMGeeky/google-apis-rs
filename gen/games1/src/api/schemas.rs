...
pub struct LinkPersonaRequest {
    ...
    pub cardinality_constraint: Option<LinkPersonaRequestCardinalityConstraintEnum>,
    ...
    pub conflicting_links_resolution_policy: Option<LinkPersonaRequestConflictingLinksResolutionPolicyEnum>,
...
pub struct LinkPersonaResponse {
    ...
    pub state: Option<LinkPersonaResponseStateEnum>,
}
