...
///              .state(&AchievementStateEnum::ALL)
...
///              .end_point_type(&ApplicationEndPointTypeEnum::PROFILECREATION)
///              .application_id("duo")
///              .doit().await;
/// # }
/// ```
...
pub struct PlayerGetMultipleApplicationPlayerIdCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _application_ids: Vec<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct RecallLinkPersonaCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _request: LinkPersonaRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct RecallResetPersonaCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _request: ResetPersonaRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct RecallUnlinkPersonaCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _request: UnlinkPersonaRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
///              .max_results(-34)
///              .language("et")
///              .include_rank_type(&ScoreIncludeRankTypeEnum::ALL)
///              .doit().await;
/// # }
/// ```
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.scores().submit("leaderboardId", -88)
///              .score_tag("Stet")
///              .language("vero")
///              .doit().await;
/// # }
