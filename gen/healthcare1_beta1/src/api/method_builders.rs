...
impl<'a, S> ProjectMethods<'a, S> {
    ...
    /// # Arguments
    ///
    /// * `resource` - Required. The path of the resource for which the storage info is requested (for exaxmple for a DICOM Instance: `projects/{projectID}/locations/{locationID}/datasets/{datasetID}/dicomStores/{dicomStoreId}/dicomWeb/studies/{study_uid}/series/{series_uid}/instances/{instance_uid}`)
    ...
    pub fn locations_datasets_fhir_stores_fhir__consent_enforcement_status(&self, name: &str) -> ProjectLocationDatasetFhirStoreFhirConsentEnforcementStatusCall<'a, S> {
        ProjectLocationDatasetFhirStoreFhirConsentEnforcementStatusCall {
            hub: self.hub,
            _name: name.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
    ...
    pub fn locations_datasets_fhir_stores_fhir__patient_consent_enforcement_status(&self, name: &str) -> ProjectLocationDatasetFhirStoreFhirPatientConsentEnforcementStatusCall<'a, S> {
        ProjectLocationDatasetFhirStoreFhirPatientConsentEnforcementStatusCall {
            hub: self.hub,
            _name: name.to_string(),
