...
pub struct AccessDeterminationLogConfig {
    ...
    pub log_level: Option<AccessDeterminationLogConfigLogLevelEnum>,
}
...
pub struct AnalyzeEntitiesRequest {
    ...
    pub alternative_output_format: Option<AnalyzeEntitiesRequestAlternativeOutputFormatEnum>,
...
pub struct BlobStorageInfo {
    ...
    pub storage_class: Option<BlobStorageInfoStorageClassEnum>,
...
pub struct BlobStorageSettings {
    ...
    pub blob_storage_class: Option<BlobStorageSettingBlobStorageClassEnum>,
}
...
pub struct ConsentConfig {
    ...
    pub version: Option<ConsentConfigVersionEnum>,
}
...
pub struct ConsentHeaderHandling {
    ...
    pub profile: Option<ConsentHeaderHandlingProfileEnum>,
}
...
pub struct ExplainDataAccessConsentInfo {
    ...
    pub type_: Option<ExplainDataAccessConsentInfoTypeEnum>,
    /// The consent's variant combinations. A single consent may have multiple variants.
    
    pub variants: Option<Vec<ExplainDataAccessConsentInfoVariantsEnum>>,
}
...
pub struct ExplainDataAccessConsentScope {
    ...
    pub decision: Option<ExplainDataAccessConsentScopeDecisionEnum>,
...
/// * [locations datasets fhir stores fhir  consent-enforcement-status projects](ProjectLocationDatasetFhirStoreFhirConsentEnforcementStatusCall) (response)
...
/// * [locations datasets fhir stores fhir  patient-consent-enforcement-status projects](ProjectLocationDatasetFhirStoreFhirPatientConsentEnforcementStatusCall) (response)
...
pub struct RollbackFhirResourcesRequest {
    ...
    pub change_type: Option<RollbackFhirResourcesRequestChangeTypeEnum>,
