...
pub struct AlbumAddEnrichmentCall<'a, S>
   ...
   pub(super) _request: AddEnrichmentToAlbumRequest,
   pub(super) _album_id: String,
...
pub struct AlbumBatchAddMediaItemCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _request: BatchAddMediaItemsToAlbumRequest,
   pub(super) _album_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct AlbumBatchRemoveMediaItemCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _request: BatchRemoveMediaItemsFromAlbumRequest,
   pub(super) _album_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct AlbumCreateCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _request: CreateAlbumRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AlbumListCall<'a, S>
   ...
   pub(super) _exclude_non_app_created_data: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AlbumShareCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _request: ShareAlbumRequest,
   pub(super) _album_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct AlbumUnshareCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _request: UnshareAlbumRequest,
   pub(super) _album_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct MediaItemBatchCreateCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _request: BatchCreateMediaItemsRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MediaItemBatchGetCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _media_item_ids: Vec<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MediaItemGetCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _media_item_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MediaItemSearchCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _request: SearchMediaItemsRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct SharedAlbumJoinCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _request: JoinSharedAlbumRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct SharedAlbumLeaveCall<'a, S>
   ...
   pub(super) hub: &'a PhotosLibrary<S>,
   pub(super) _request: LeaveSharedAlbumRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
