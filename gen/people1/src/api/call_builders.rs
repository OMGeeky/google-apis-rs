...
pub struct ContactGroupMemberModifyCall<'a, S>
   ...
   pub(super) _request: ModifyContactGroupMembersRequest,
...
pub struct ContactGroupBatchGetCall<'a, S>
   ...
   pub(super) _max_members: Option<i32>,
   pub(super) _group_fields: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ContactGroupCreateCall<'a, S>
   ...
   pub(super) hub: &'a PeopleService<S>,
   pub(super) _request: CreateContactGroupRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ContactGroupDeleteCall<'a, S>
   ...
   pub(super) hub: &'a PeopleService<S>,
   pub(super) _resource_name: String,
   pub(super) _delete_contacts: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ContactGroupUpdateCall<'a, S>
   ...
   pub(super) hub: &'a PeopleService<S>,
   pub(super) _request: UpdateContactGroupRequest,
   pub(super) _resource_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct OtherContactCopyOtherContactToMyContactsGroupCall<'a, S>
   ...
   pub(super) hub: &'a PeopleService<S>,
   pub(super) _request: CopyOtherContactToMyContactsGroupRequest,
   pub(super) _resource_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
///              .sync_token("amet")
///              .add_sources(&OtherContactSourcesEnum::READSOURCETYPEUNSPECIFIED)
...
///              .sync_token("ipsum")
///              .add_sources(&PersonSourcesEnum::READSOURCETYPEUNSPECIFIED)
///              .sort_order(&PersonSortOrderEnum::LASTMODIFIEDASCENDING)
///              .request_sync_token(true)
...
pub struct PersonBatchCreateContactCall<'a, S>
   ...
   pub(super) hub: &'a PeopleService<S>,
   pub(super) _request: BatchCreateContactsRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct PersonBatchDeleteContactCall<'a, S>
   ...
   pub(super) hub: &'a PeopleService<S>,
   pub(super) _request: BatchDeleteContactsRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct PersonBatchUpdateContactCall<'a, S>
   ...
   pub(super) hub: &'a PeopleService<S>,
   pub(super) _request: BatchUpdateContactsRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
///              .page_token("duo")
///              .page_size(-80)
///              .add_merge_sources(&PersonMergeSourcesEnum::DIRECTORYMERGESOURCETYPEUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
...
pub struct PersonUpdateContactPhotoCall<'a, S>
   ...
   pub(super) hub: &'a PeopleService<S>,
   pub(super) _request: UpdateContactPhotoRequest,
   pub(super) _resource_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
