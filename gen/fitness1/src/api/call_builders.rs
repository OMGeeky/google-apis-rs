...
pub struct UserDataSourceDataPointChangeListCall<'a, S>
   ...
   pub(super) _data_source_id: String,
...
pub struct UserDataSourceListCall<'a, S>
   ...
   pub(super) hub: &'a Fitness<S>,
   pub(super) _user_id: String,
   pub(super) _data_type_name: Vec<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct UserDatasetAggregateCall<'a, S>
   ...
   pub(super) hub: &'a Fitness<S>,
   pub(super) _request: AggregateRequest,
   pub(super) _user_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct UserSessionListCall<'a, S>
   ...
   pub(super) hub: &'a Fitness<S>,
   pub(super) _user_id: String,
   pub(super) _start_time: Option<String>,
   pub(super) _page_token: Option<String>,
   pub(super) _include_deleted: Option<bool>,
   pub(super) _end_time: Option<String>,
   pub(super) _activity_type: Vec<i32>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
