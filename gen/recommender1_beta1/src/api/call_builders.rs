...
pub struct BillingAccountLocationInsightTypeInsightMarkAcceptedCall<'a, S>
   ...
   pub(super) hub: &'a Recommender<S>,
   pub(super) _request: GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct BillingAccountLocationInsightTypeUpdateConfigCall<'a, S>
   ...
   pub(super) hub: &'a Recommender<S>,
   pub(super) _request: GoogleCloudRecommenderV1beta1InsightTypeConfig,
   pub(super) _name: String,
...
pub struct BillingAccountLocationRecommenderRecommendationMarkClaimedCall<'a, S>
   ...
   pub(super) hub: &'a Recommender<S>,
   pub(super) _request: GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct BillingAccountLocationRecommenderRecommendationMarkDismissedCall<'a, S>
   ...
   pub(super) hub: &'a Recommender<S>,
   pub(super) _request: GoogleCloudRecommenderV1beta1MarkRecommendationDismissedRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct BillingAccountLocationRecommenderRecommendationMarkFailedCall<'a, S>
   ...
   pub(super) hub: &'a Recommender<S>,
   pub(super) _request: GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct BillingAccountLocationRecommenderRecommendationMarkSucceededCall<'a, S>
   ...
   pub(super) hub: &'a Recommender<S>,
   pub(super) _request: GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct BillingAccountLocationRecommenderUpdateConfigCall<'a, S>
   ...
   pub(super) hub: &'a Recommender<S>,
   pub(super) _request: GoogleCloudRecommenderV1beta1RecommenderConfig,
   pub(super) _name: String,
   pub(super) _validate_only: Option<bool>,
   pub(super) _update_mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
