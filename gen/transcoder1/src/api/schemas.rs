...
pub struct DashConfig {
    ...
    pub segment_reference_scheme: Option<DashConfigSegmentReferenceSchemeEnum>,
}
...
pub struct H264CodecSettings {
    ...
    pub frame_rate_conversion_strategy: Option<H264CodecSettingFrameRateConversionStrategyEnum>,
...
pub struct H265CodecSettings {
    ...
    pub frame_rate_conversion_strategy: Option<H265CodecSettingFrameRateConversionStrategyEnum>,
    /// Select the GOP size based on the specified duration. The default is `3s`. Note that `gopDuration` must be less than or equal to [`segmentDuration`](#SegmentSettings), and [`segmentDuration`](#SegmentSettings) must be divisible by `gopDuration`.
    #[serde(rename="gopDuration")]
...
pub struct Job {
    ...
    pub mode: Option<JobModeEnum>,
    /// The resource name of the job. Format: `projects/{project_number}/locations/{location}/jobs/{job}`
    
    pub name: Option<String>,
    /// Optional. The optimization strategy of the job. The default is `AUTODETECT`.
    
    pub optimization: Option<JobOptimizationEnum>,
...
pub struct Vp9CodecSettings {
    ...
    pub frame_rate_conversion_strategy: Option<Vp9CodecSettingFrameRateConversionStrategyEnum>,
    /// Select the GOP size based on the specified duration. The default is `3s`. Note that `gopDuration` must be less than or equal to [`segmentDuration`](#SegmentSettings), and [`segmentDuration`](#SegmentSettings) must be divisible by `gopDuration`.
    #[serde(rename="gopDuration")]
