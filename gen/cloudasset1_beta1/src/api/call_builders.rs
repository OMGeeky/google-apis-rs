...
/// use cloudasset1_beta1::api::enums::*;
/// # async fn dox() {
...
///              .content_type(&OrganizationContentTypeEnum::CONTENTTYPEUNSPECIFIED)
///              .add_asset_names("sed")
///              .doit().await;
/// # }
/// ```
...
///              .read_time_window_start_time(chrono::Utc::now())
///              .read_time_window_end_time(chrono::Utc::now())
///              .content_type(&ProjectContentTypeEnum::CONTENTTYPEUNSPECIFIED)
///              .add_asset_names("duo")
///              .doit().await;
/// # }
/// ```
