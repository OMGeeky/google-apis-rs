    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub fn update_mask(mut self, new_value: client::FieldMask) -> AccountAdminPatchCall<'a, S> {
...
pub struct AccountListCall<'a, S>
   ...
   pub(super) hub: &'a MyBusinessAccountManagement<S>,
   pub(super) _parent_account: Option<String>,
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    ///
    /// Sets the *update mask* query property to the given value.
    pub fn update_mask(mut self, new_value: client::FieldMask) -> AccountPatchCall<'a, S> {
        self._update_mask = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    ///
    /// Sets the *update mask* query property to the given value.
    pub fn update_mask(mut self, new_value: client::FieldMask) -> LocationAdminPatchCall<'a, S> {
        self._update_mask = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.locations.transfer",
                               http_method: hyper::Method::POST });
