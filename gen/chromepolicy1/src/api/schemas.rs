...
pub struct GoogleChromePolicyVersionsV1PolicyApiLifecycle {
    ...
    pub policy_api_lifecycle_stage: Option<GoogleChromePolicyVersionsV1PolicyApiLifecyclePolicyApiLifecycleStageEnum>,
...
pub struct GoogleChromePolicyVersionsV1PolicySchema {
    ...
    pub supported_platforms: Option<Vec<GoogleChromePolicyVersionsV1PolicySchemaSupportedPlatformsEnum>>,
...
pub struct GoogleChromePolicyVersionsV1UploadedFileConstraints {
    ...
    pub supported_content_types: Option<Vec<GoogleChromePolicyVersionsV1UploadedFileConstraintSupportedContentTypesEnum>>,
}
