...
///              .client_info_platform(&FeaturetileClientInfoPlatformEnum::PLATFORMUNSPECIFIED)
...
///              .add_terrain_formats(&TerraintileTerrainFormatsEnum::TERRAINFORMATUNKNOWN)
///              .min_elevation_resolution_cells(-7)
///              .max_elevation_resolution_cells(-27)
///              .client_info_user_id("sed")
///              .client_info_platform(&TerraintileClientInfoPlatformEnum::PLATFORMUNSPECIFIED)
