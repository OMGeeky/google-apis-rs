...
pub struct AccountContainerEnvironmentCreateCall<'a, S>
   ...
   pub(super) _container_id: String,
...
pub struct AccountContainerEnvironmentDeleteCall<'a, S>
   ...
   pub(super) _account_id: String,
   pub(super) _container_id: String,
   pub(super) _environment_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AccountContainerEnvironmentUpdateCall<'a, S>
   ...
   pub(super) _container_id: String,
   pub(super) _environment_id: String,
   pub(super) _fingerprint: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AccountContainerMoveFolderUpdateCall<'a, S>
   ...
   pub(super) _container_id: String,
   pub(super) _folder_id: String,
   pub(super) _variable_id: Vec<String>,
   pub(super) _trigger_id: Vec<String>,
   pub(super) _tag_id: Vec<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AccountContainerVersionCreateCall<'a, S>
   ...
   pub(super) hub: &'a TagManager<S>,
   pub(super) _request: CreateContainerVersionRequestVersionOptions,
   pub(super) _account_id: String,
   pub(super) _container_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct AccountContainerVersionDeleteCall<'a, S>
   ...
   pub(super) _account_id: String,
   pub(super) _container_id: String,
   pub(super) _container_version_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AccountContainerVersionListCall<'a, S>
   ...
   pub(super) _headers: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AccountContainerVersionUpdateCall<'a, S>
   ...
   pub(super) hub: &'a TagManager<S>,
   pub(super) _request: ContainerVersion,
   pub(super) _account_id: String,
   pub(super) _container_id: String,
   pub(super) _container_version_id: String,
   pub(super) _fingerprint: Option<String>,
