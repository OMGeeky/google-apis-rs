...
pub struct ProjectClientEventCreateCall<'a, S>
   ...
   pub(super) _request: CreateClientEventRequest,
...
pub struct ProjectCompanyCreateCall<'a, S>
   ...
   pub(super) hub: &'a CloudTalentSolution<S>,
   pub(super) _request: CreateCompanyRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectCompanyPatchCall<'a, S>
   ...
   pub(super) hub: &'a CloudTalentSolution<S>,
   pub(super) _request: UpdateCompanyRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectJobCreateCall<'a, S>
   ...
   pub(super) hub: &'a CloudTalentSolution<S>,
   pub(super) _request: CreateJobRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
///              .page_token("ea")
///              .page_size(-55)
///              .job_view(&ProjectJobViewEnum::JOBVIEWUNSPECIFIED)
///              .filter("invidunt")
///              .doit().await;
/// # }
/// ```
...
pub struct ProjectJobPatchCall<'a, S>
   ...
   pub(super) hub: &'a CloudTalentSolution<S>,
   pub(super) _request: UpdateJobRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
///              .type_(&ProjectTypeEnum::COMPLETIONTYPEUNSPECIFIED)
///              .scope(&ProjectScopeEnum::COMPLETIONSCOPEUNSPECIFIED)
///              .query("ut")
///              .page_size(-12)
