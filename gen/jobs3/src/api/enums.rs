...
// region CompensationHistogramRequestTypeEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
...
impl AsRef<str> for CompensationHistogramRequestTypeEnum {
    fn as_ref(&self) -> &str {
        match *self {
...
impl std::convert::TryFrom< &str> for CompensationHistogramRequestTypeEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "COMPENSATION_HISTOGRAM_REQUEST_TYPE_UNSPECIFIED" => Ok(CompensationHistogramRequestTypeEnum::COMPENSATIONHISTOGRAMREQUESTTYPEUNSPECIFIED),
           "BASE" => Ok(CompensationHistogramRequestTypeEnum::BASE),
           "ANNUALIZED_BASE" => Ok(CompensationHistogramRequestTypeEnum::ANNUALIZEDBASE),
           "ANNUALIZED_TOTAL" => Ok(CompensationHistogramRequestTypeEnum::ANNUALIZEDTOTAL),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a CompensationHistogramRequestTypeEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
// region CompensationHistogramResultTypeEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
...
impl AsRef<str> for CompensationHistogramResultTypeEnum {
    fn as_ref(&self) -> &str {
        match *self {
...
impl std::convert::TryFrom< &str> for CompensationHistogramResultTypeEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "COMPENSATION_HISTOGRAM_REQUEST_TYPE_UNSPECIFIED" => Ok(CompensationHistogramResultTypeEnum::COMPENSATIONHISTOGRAMREQUESTTYPEUNSPECIFIED),
           "BASE" => Ok(CompensationHistogramResultTypeEnum::BASE),
           "ANNUALIZED_BASE" => Ok(CompensationHistogramResultTypeEnum::ANNUALIZEDBASE),
           "ANNUALIZED_TOTAL" => Ok(CompensationHistogramResultTypeEnum::ANNUALIZEDTOTAL),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a CompensationHistogramResultTypeEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
impl AsRef<str> for HistogramFacetSimpleHistogramFacetsEnum {
    fn as_ref(&self) -> &str {
        match *self {
            HistogramFacetSimpleHistogramFacetsEnum::SEARCHTYPEUNSPECIFIED => "SEARCH_TYPE_UNSPECIFIED",
            HistogramFacetSimpleHistogramFacetsEnum::COMPANYID => "COMPANY_ID",
            HistogramFacetSimpleHistogramFacetsEnum::EMPLOYMENTTYPE => "EMPLOYMENT_TYPE",
            HistogramFacetSimpleHistogramFacetsEnum::COMPANYSIZE => "COMPANY_SIZE",
            HistogramFacetSimpleHistogramFacetsEnum::DATEPUBLISHED => "DATE_PUBLISHED",
            HistogramFacetSimpleHistogramFacetsEnum::EDUCATIONLEVEL => "EDUCATION_LEVEL",
            HistogramFacetSimpleHistogramFacetsEnum::EXPERIENCELEVEL => "EXPERIENCE_LEVEL",
            HistogramFacetSimpleHistogramFacetsEnum::ADMIN1 => "ADMIN_1",
            HistogramFacetSimpleHistogramFacetsEnum::COUNTRY => "COUNTRY",
            HistogramFacetSimpleHistogramFacetsEnum::CITY => "CITY",
            HistogramFacetSimpleHistogramFacetsEnum::LOCALE => "LOCALE",
            HistogramFacetSimpleHistogramFacetsEnum::LANGUAGE => "LANGUAGE",
            HistogramFacetSimpleHistogramFacetsEnum::CATEGORY => "CATEGORY",
            HistogramFacetSimpleHistogramFacetsEnum::CITYCOORDINATE => "CITY_COORDINATE",
            HistogramFacetSimpleHistogramFacetsEnum::ADMIN1COUNTRY => "ADMIN_1_COUNTRY",
            HistogramFacetSimpleHistogramFacetsEnum::COMPANYDISPLAYNAME => "COMPANY_DISPLAY_NAME",
            HistogramFacetSimpleHistogramFacetsEnum::BASECOMPENSATIONUNIT => "BASE_COMPENSATION_UNIT",
        }
    }
}

impl std::convert::TryFrom< &str> for HistogramFacetSimpleHistogramFacetsEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "SEARCH_TYPE_UNSPECIFIED" => Ok(HistogramFacetSimpleHistogramFacetsEnum::SEARCHTYPEUNSPECIFIED),
           "COMPANY_ID" => Ok(HistogramFacetSimpleHistogramFacetsEnum::COMPANYID),
           "EMPLOYMENT_TYPE" => Ok(HistogramFacetSimpleHistogramFacetsEnum::EMPLOYMENTTYPE),
           "COMPANY_SIZE" => Ok(HistogramFacetSimpleHistogramFacetsEnum::COMPANYSIZE),
           "DATE_PUBLISHED" => Ok(HistogramFacetSimpleHistogramFacetsEnum::DATEPUBLISHED),
           "EDUCATION_LEVEL" => Ok(HistogramFacetSimpleHistogramFacetsEnum::EDUCATIONLEVEL),
           "EXPERIENCE_LEVEL" => Ok(HistogramFacetSimpleHistogramFacetsEnum::EXPERIENCELEVEL),
           "ADMIN_1" => Ok(HistogramFacetSimpleHistogramFacetsEnum::ADMIN1),
           "COUNTRY" => Ok(HistogramFacetSimpleHistogramFacetsEnum::COUNTRY),
           "CITY" => Ok(HistogramFacetSimpleHistogramFacetsEnum::CITY),
           "LOCALE" => Ok(HistogramFacetSimpleHistogramFacetsEnum::LOCALE),
           "LANGUAGE" => Ok(HistogramFacetSimpleHistogramFacetsEnum::LANGUAGE),
           "CATEGORY" => Ok(HistogramFacetSimpleHistogramFacetsEnum::CATEGORY),
           "CITY_COORDINATE" => Ok(HistogramFacetSimpleHistogramFacetsEnum::CITYCOORDINATE),
           "ADMIN_1_COUNTRY" => Ok(HistogramFacetSimpleHistogramFacetsEnum::ADMIN1COUNTRY),
           "COMPANY_DISPLAY_NAME" => Ok(HistogramFacetSimpleHistogramFacetsEnum::COMPANYDISPLAYNAME),
           "BASE_COMPENSATION_UNIT" => Ok(HistogramFacetSimpleHistogramFacetsEnum::BASECOMPENSATIONUNIT),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a HistogramFacetSimpleHistogramFacetsEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
// region HistogramResultSearchTypeEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
...
impl AsRef<str> for HistogramResultSearchTypeEnum {
    fn as_ref(&self) -> &str {
        match *self {
...
impl std::convert::TryFrom< &str> for HistogramResultSearchTypeEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "SEARCH_TYPE_UNSPECIFIED" => Ok(HistogramResultSearchTypeEnum::SEARCHTYPEUNSPECIFIED),
           "COMPANY_ID" => Ok(HistogramResultSearchTypeEnum::COMPANYID),
           "EMPLOYMENT_TYPE" => Ok(HistogramResultSearchTypeEnum::EMPLOYMENTTYPE),
           "COMPANY_SIZE" => Ok(HistogramResultSearchTypeEnum::COMPANYSIZE),
           "DATE_PUBLISHED" => Ok(HistogramResultSearchTypeEnum::DATEPUBLISHED),
           "EDUCATION_LEVEL" => Ok(HistogramResultSearchTypeEnum::EDUCATIONLEVEL),
           "EXPERIENCE_LEVEL" => Ok(HistogramResultSearchTypeEnum::EXPERIENCELEVEL),
           "ADMIN_1" => Ok(HistogramResultSearchTypeEnum::ADMIN1),
           "COUNTRY" => Ok(HistogramResultSearchTypeEnum::COUNTRY),
           "CITY" => Ok(HistogramResultSearchTypeEnum::CITY),
           "LOCALE" => Ok(HistogramResultSearchTypeEnum::LOCALE),
           "LANGUAGE" => Ok(HistogramResultSearchTypeEnum::LANGUAGE),
           "CATEGORY" => Ok(HistogramResultSearchTypeEnum::CATEGORY),
           "CITY_COORDINATE" => Ok(HistogramResultSearchTypeEnum::CITYCOORDINATE),
           "ADMIN_1_COUNTRY" => Ok(HistogramResultSearchTypeEnum::ADMIN1COUNTRY),
           "COMPANY_DISPLAY_NAME" => Ok(HistogramResultSearchTypeEnum::COMPANYDISPLAYNAME),
           "BASE_COMPENSATION_UNIT" => Ok(HistogramResultSearchTypeEnum::BASECOMPENSATIONUNIT),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a HistogramResultSearchTypeEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
impl std::convert::TryFrom< &str> for JobEventTypeEnum {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           ...
           "NOT_INTERESTED" => Ok(JobEventTypeEnum::NOTINTERESTED),
            _=> Err(()),
        }
    }
}
