...
pub struct NamespaceConfigurationListCall<'a, S>
   ...
   pub(super) hub: &'a CloudRun<S>,
   pub(super) _parent: String,
   pub(super) _watch: Option<bool>,
   pub(super) _resource_version: Option<String>,
   pub(super) _limit: Option<i32>,
   pub(super) _label_selector: Option<String>,
   pub(super) _include_uninitialized: Option<bool>,
   pub(super) _field_selector: Option<String>,
   pub(super) _continue_: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct NamespaceDomainmappingCreateCall<'a, S>
   ...
   pub(super) _parent: String,
   pub(super) _dry_run: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct NamespaceDomainmappingDeleteCall<'a, S>
   ...
   pub(super) hub: &'a CloudRun<S>,
   pub(super) _name: String,
   pub(super) _propagation_policy: Option<String>,
   pub(super) _kind: Option<String>,
   pub(super) _dry_run: Option<String>,
   pub(super) _api_version: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct NamespaceJobRunCall<'a, S>
   ...
   pub(super) hub: &'a CloudRun<S>,
   pub(super) _request: RunJobRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
/// # extern crate hyper_rustls;
/// # extern crate google_run1 as run1;
/// use run1::api::GoogleLongrunningWaitOperationRequest;
/// use run1::api::enums::*;
/// # async fn dox() {
/// # use std::default::Default;
/// # use run1::{CloudRun, oauth2, hyper, hyper_rustls, chrono, FieldMask};
...
///              .watch(false)
///              .resource_version("dolores")
///              .limit(-46)
///              .label_selector("gubergren")
///              .include_uninitialized(true)
///              .field_selector("amet.")
///              .continue_("ipsum")
///              .doit().await;
...
///              .watch(false)
///              .resource_version("rebum.")
///              .limit(-39)
///              .label_selector("dolore")
///              .include_uninitialized(true)
///              .field_selector("dolore")
///              .continue_("amet")
///              .doit().await;
/// # }
/// ```
