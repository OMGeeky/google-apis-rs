...
The [delegate trait](https://docs.rs/google-tagmanager2/5.0.5+20240419/google_tagmanager2/client::Delegate) is default-implemented, allowing you to customize it with minimal effort.
