...
pub struct FolderApprovalRequestApproveCall<'a, S>
   ...
   pub(super) _request: ApproveApprovalRequestMessage,
...
pub struct FolderApprovalRequestDismisCall<'a, S>
   ...
   pub(super) hub: &'a AccessApproval<S>,
   pub(super) _request: DismissApprovalRequestMessage,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct FolderApprovalRequestInvalidateCall<'a, S>
   ...
   pub(super) hub: &'a AccessApproval<S>,
   pub(super) _request: InvalidateApprovalRequestMessage,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct FolderUpdateAccessApprovalSettingCall<'a, S>
   ...
   pub(super) hub: &'a AccessApproval<S>,
   pub(super) _request: AccessApprovalSettings,
   pub(super) _name: String,
