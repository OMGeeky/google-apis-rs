...
use deploymentmanager2_beta2::api::enums::*;
...
let result = hub.deployments().patch(req, "project", "deployment")
             .update_policy(&DeploymentUpdatePolicyEnum::PATCH)
             .delete_policy(&DeploymentDeletePolicyEnum::ABANDON)
             .create_policy(&DeploymentCreatePolicyEnum::ACQUIRE)
             .doit().await;
