...
///              .locale("Lorem")
///              .license_types(&MyconfigLicenseTypesEnum::LICENSETYPESUNDEFINED)
///              .doit().await;
/// # }
/// ```
...
///              .add_features(&MyconfigFeaturesEnum::FEATURESUNDEFINED)
///              .doit().await;
/// # }
/// ```
...
///              .show_preorders(true)
///              .q("est")
///              .projection(&MylibraryProjectionEnum::PROJECTIONUNDEFINED)
///              .max_results(48)
///              .country("sed")
///              .doit().await;
/// # }
...
///              .source("ea")
///              .reason(&MylibraryReasonEnum::REASONUNDEFINED)
///              .doit().await;
/// # }
/// ```
...
///              .device_cookie("et")
///              .content_version("At")
///              .action(&MylibraryActionEnum::ACTIONUNDEFINED)
///              .doit().await;
/// # }
/// ```
...
///              .page_token("sea")
///              .page_size(60)
///              .max_allowed_maturity_rating(&OnboardingMaxAllowedMaturityRatingEnum::MAXALLOWEDMATURITYRATINGUNDEFINED)
///              .locale("et")
...
///              .source("justo")
///              .max_allowed_maturity_rating(&PersonalizedstreamMaxAllowedMaturityRatingEnum::MAXALLOWEDMATURITYRATINGUNDEFINED)
///              .locale("sea")
///              .doit().await;
/// # }
/// ```
...
///              .source("justo")
///              .max_allowed_maturity_rating(&VolumeMaxAllowedMaturityRatingEnum::MAXALLOWEDMATURITYRATINGUNDEFINED)
///              .locale("amet.")
///              .association(&VolumeAssociationEnum::ASSOCIATIONUNDEFINED)
///              .doit().await;
/// # }
/// ```
...
///              .start_index(90)
///              .source("nonumy")
///              .add_processing_state(&VolumeProcessingStateEnum::PROCESSINGSTATEUNDEFINED)
///              .max_results(58)
///              .locale("kasd")
///              .country("Lorem")
///              .add_acquire_method(&VolumeAcquireMethodEnum::ACQUIREMETHODUNDEFINED)
///              .doit().await;
/// # }
/// ```
...
///              .source("vero")
///              .projection(&VolumeProjectionEnum::PROJECTIONUNDEFINED)
///              .partner("duo")
...
///              .projection(&VolumeProjectionEnum::PROJECTIONUNDEFINED)
///              .print_type(&VolumePrintTypeEnum::PRINTTYPEUNDEFINED)
///              .partner("tempor")
///              .order_by(&VolumeOrderByEnum::ORDERBYUNDEFINED)
///              .max_results(91)
///              .max_allowed_maturity_rating(&VolumeMaxAllowedMaturityRatingEnum::MAXALLOWEDMATURITYRATINGUNDEFINED)
///              .library_restrict(&VolumeLibraryRestrictEnum::LIBRARYRESTRICTUNDEFINED)
///              .lang_restrict("et")
///              .filter(&VolumeFilterEnum::FILTERUNDEFINED)
///              .download(&VolumeDownloadEnum::DOWNLOADUNDEFINED)
///              .doit().await;
/// # }
/// ```
