...
The [delegate trait](https://docs.rs/google-dlp2/5.0.5+20240414/google_dlp2/client::Delegate) is default-implemented, allowing you to customize it with minimal effort.
