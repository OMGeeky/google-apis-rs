...
pub struct ChannelStatus {
    ...
    pub long_uploads_status: Option<ChannelStatusLongUploadsStatusEnum>,
    /// no description provided
    ...
    pub privacy_status: Option<ChannelStatusPrivacyStatusEnum>,
    /// no description provided
...
pub struct ChannelToStoreLinkDetailsBillingDetails {
    ...
    pub billing_status: Option<ChannelToStoreLinkDetailsBillingDetailBillingStatusEnum>,
}

impl client::Part for ChannelToStoreLinkDetailsBillingDetails {}
...
/// * [set moderation status comments](CommentSetModerationStatusCall) (none)
...
pub struct CuepointSchedule {
    ...
    pub schedule_strategy: Option<CuepointScheduleScheduleStrategyEnum>,
}

impl client::Part for CuepointSchedule {}
...
impl client::Part for LiveBroadcastMonetizationDetails {}
...
pub struct LiveBroadcastStatus {
    ...
    pub life_cycle_status: Option<LiveBroadcastStatusLifeCycleStatusEnum>,
    /// Priority of the live broadcast event (internal state).
    #[serde(rename="liveBroadcastPriority")]
    
    pub live_broadcast_priority: Option<LiveBroadcastStatusLiveBroadcastPriorityEnum>,
    ...
    pub privacy_status: Option<LiveBroadcastStatusPrivacyStatusEnum>,
    /// The broadcast's recording status.
    #[serde(rename="recordingStatus")]
    
    pub recording_status: Option<LiveBroadcastStatusRecordingStatusEnum>,
...
impl client::ToParts for LiveChatMessageListResponse {
    ...
    fn to_parts(&self) -> String {
        let mut r = String::new();
        if self.active_poll_item.is_some() { r = r + "activePollItem,"; }
        if self.etag.is_some() { r = r + "etag,"; }
        if self.event_id.is_some() { r = r + "eventId,"; }
        if self.items.is_some() { r = r + "items,"; }
        if self.kind.is_some() { r = r + "kind,"; }
...
pub struct LiveChatPollDetails {
    ...
    pub status: Option<LiveChatPollDetailStatusEnum>,
}

impl client::Part for LiveChatPollDetails {}
...
impl client::Part for LiveChatPollDetailsPollMetadata {}
...
impl client::Part for LiveChatPollDetailsPollMetadataPollOption {}
...
pub struct LiveStreamHealthStatus {
    ...
    pub status: Option<LiveStreamHealthStatusStatusEnum>,
}
...
pub struct LiveStreamStatus {
    ...
    pub stream_status: Option<LiveStreamStatusStreamStatusEnum>,
}
...
impl client::RequestValue for PlaylistImage {}
impl client::Resource for PlaylistImage {}
impl client::ResponseResult for PlaylistImage {}

impl client::ToParts for PlaylistImage {
    /// Return a comma separated list of members that are currently set, i.e. for which `self.member.is_some()`.
    /// The produced string is suitable for use as a parts list that indicates the parts you are sending, and/or
    /// the parts you want to see in the server response.
    fn to_parts(&self) -> String {
...
impl client::ResponseResult for PlaylistImageListResponse {}

impl client::ToParts for PlaylistImageListResponse {
    /// Return a comma separated list of members that are currently set, i.e. for which `self.member.is_some()`.
    /// The produced string is suitable for use as a parts list that indicates the parts you are sending, and/or
    /// the parts you want to see in the server response.
    fn to_parts(&self) -> String {
...
pub struct PlaylistImageSnippet {
    ...
    pub type_: Option<PlaylistImageSnippetTypeEnum>,
    /// The image width.
    
    pub width: Option<i32>,
}

impl client::Part for PlaylistImageSnippet {}
...
pub struct PlaylistItemStatus {
    ...
    pub privacy_status: Option<PlaylistItemStatusPrivacyStatusEnum>,
}
...
pub struct PlaylistStatus {
    ...
    pub privacy_status: Option<PlaylistStatusPrivacyStatusEnum>,
}
...
pub struct ThirdPartyLinkStatus {
    ...
    pub link_status: Option<ThirdPartyLinkStatusLinkStatusEnum>,
}
...
pub struct VideoStatus {
    ...
    pub failure_reason: Option<VideoStatusFailureReasonEnum>,
    /// The video's license. @mutable youtube.videos.insert youtube.videos.update
    
    pub license: Option<VideoStatusLicenseEnum>,
    /// no description provided
    #[serde(rename="madeForKids")]
    ...
    pub privacy_status: Option<VideoStatusPrivacyStatusEnum>,
    ...
    pub rejection_reason: Option<VideoStatusRejectionReasonEnum>,
    /// no description provided
    #[serde(rename="selfDeclaredMadeForKids")]
    ...
    pub upload_status: Option<VideoStatusUploadStatusEnum>,
}
