...
The [delegate trait](https://docs.rs/google-privateca1/5.0.5+20240410/google_privateca1/client::Delegate) is default-implemented, allowing you to customize it with minimal effort.
