...
pub struct AssetlinkBulkCheckCall<'a, S>
   ...
   pub(super) _request: BulkCheckRequest,
...
pub struct AssetlinkCheckCall<'a, S>
   ...
   pub(super) hub: &'a Digitalassetlinks<S>,
   pub(super) _target_web_site: Option<String>,
   pub(super) _target_android_app_package_name: Option<String>,
   pub(super) _target_android_app_certificate_sha256_fingerprint: Option<String>,
   pub(super) _source_web_site: Option<String>,
   pub(super) _source_android_app_package_name: Option<String>,
   pub(super) _source_android_app_certificate_sha256_fingerprint: Option<String>,
   pub(super) _relation: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
