...
impl<'a, S> AcceleratorTypeMethods<'a, S> {
    ...
    pub fn aggregated_list(&self, project: &str) -> AcceleratorTypeAggregatedListCall<'a, S> {
        AcceleratorTypeAggregatedListCall {
            ...
            _service_project_number: Default::default(),
...
/// let mut hub = Compute::new(hyper::Client::builder().build(hyper_rustls::HttpsConnectorBuilder::new().with_native_roots().unwrap().https_or_http().enable_http1().build()), auth);
/// // Usually you wouldn't bind this to a variable, but keep calling *CallBuilders*
/// // like `aggregated_list(...)`, `delete(...)`, `get(...)`, `insert(...)`, `list(...)`, `move_(...)` and `set_labels(...)`
/// // to build up your call.
...
impl<'a, S> AddressMethods<'a, S> {
    ...
    pub fn move_(&self, request: RegionAddressesMoveRequest, project: &str, region: &str, address: &str) -> AddressMoveCall<'a, S> {
        AddressMoveCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
...
impl<'a, S> BackendBucketMethods<'a, S> {
    ...
    /// * `request` - No description provided.
    /// * `project` - Project ID for this request.
    /// * `backendBucket` - Name of the BackendBucket resource to which the security policy should be set. The name should conform to RFC1035.
...
/// let mut hub = Compute::new(hyper::Client::builder().build(hyper_rustls::HttpsConnectorBuilder::new().with_native_roots().unwrap().https_or_http().enable_http1().build()), auth);
/// // Usually you wouldn't bind this to a variable, but keep calling *CallBuilders*
/// // like `add_signed_url_key(...)`, `aggregated_list(...)`, `delete(...)`, `delete_signed_url_key(...)`, `get(...)`, `get_health(...)`, `get_iam_policy(...)`, `insert(...)`, `list(...)`, `list_usable(...)`, `patch(...)`, `set_edge_security_policy(...)`, `set_iam_policy(...)`, `set_security_policy(...)`, `test_iam_permissions(...)` and `update(...)`
/// // to build up your call.
...
impl<'a, S> BackendServiceMethods<'a, S> {
    ...
    ///
    /// * `project` - Project ID for this request.
    pub fn list_usable(&self, project: &str) -> BackendServiceListUsableCall<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `resource` - Name or id of the resource for this request.
    pub fn test_iam_permissions(&self, request: TestPermissionsRequest, project: &str, resource: &str) -> BackendServiceTestIamPermissionCall<'a, S> {
...
/// # }
/// ```
pub struct InstanceGroupManagerResizeRequestMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Compute<S>,
}

impl<'a, S> client::MethodsBuilder for InstanceGroupManagerResizeRequestMethods<'a, S> {}

impl<'a, S> InstanceGroupManagerResizeRequestMethods<'a, S> {
    ...
    ///
    /// * `project` - Project ID for this request.
    /// * `zone` - The name of the zone where the managed instance group is located. The name should conform to RFC1035.
    /// * `instanceGroupManager` - The name of the managed instance group. The name should conform to RFC1035 or be a resource ID.
    /// * `resizeRequest` - The name of the resize request to cancel. The name should conform to RFC1035 or be a resource ID.
    pub fn cancel(&self, project: &str, zone: &str, instance_group_manager: &str, resize_request: &str) -> InstanceGroupManagerResizeRequestCancelCall<'a, S> {
        InstanceGroupManagerResizeRequestCancelCall {
            hub: self.hub,
            _project: project.to_string(),
            _zone: zone.to_string(),
            _instance_group_manager: instance_group_manager.to_string(),
            _resize_request: resize_request.to_string(),
            _request_id: Default::default(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
    ...
    /// * `zone` - The name of the zone where the managed instance group is located. The name should conform to RFC1035.
    /// * `instanceGroupManager` - The name of the managed instance group. The name should conform to RFC1035 or be a resource ID.
    /// * `resizeRequest` - The name of the resize request to delete. The name should conform to RFC1035 or be a resource ID.
    pub fn delete(&self, project: &str, zone: &str, instance_group_manager: &str, resize_request: &str) -> InstanceGroupManagerResizeRequestDeleteCall<'a, S> {
    ...
    ///
    /// * `project` - Project ID for this request.
    /// * `zone` - Name of the href="/compute/docs/regions-zones/#available">zone scoping this request. Name should conform to RFC1035.
    /// * `instanceGroupManager` - The name of the managed instance group. Name should conform to RFC1035 or be a resource ID.
    /// * `resizeRequest` - The name of the resize request. Name should conform to RFC1035 or be a resource ID.
    pub fn get(&self, project: &str, zone: &str, instance_group_manager: &str, resize_request: &str) -> InstanceGroupManagerResizeRequestGetCall<'a, S> {
    ...
    /// * `request` - No description provided.
    /// * `project` - Project ID for this request.
    /// * `zone` - The name of the zone where the managed instance group is located and where the resize request will be created. Name should conform to RFC1035.
    /// * `instanceGroupManager` - The name of the managed instance group to which the resize request will be added. Name should conform to RFC1035 or be a resource ID.
    pub fn insert(&self, request: InstanceGroupManagerResizeRequest, project: &str, zone: &str, instance_group_manager: &str) -> InstanceGroupManagerResizeRequestInsertCall<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `zone` - The name of the zone where the managed instance group is located. The name should conform to RFC1035.
    /// * `instanceGroupManager` - The name of the managed instance group. The name should conform to RFC1035.
    pub fn list(&self, project: &str, zone: &str, instance_group_manager: &str) -> InstanceGroupManagerResizeRequestListCall<'a, S> {
...
/// A builder providing access to all methods supported on *instanceSetting* resources.
/// It is not used directly, but through the [`Compute`] hub.
///
/// # Example
///
...
/// // like `get(...)` and `patch(...)`
/// // to build up your call.
/// let rb = hub.instance_settings();
/// # }
/// ```
pub struct InstanceSettingMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Compute<S>,
}

impl<'a, S> client::MethodsBuilder for InstanceSettingMethods<'a, S> {}

impl<'a, S> InstanceSettingMethods<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `zone` - Name of the zone for this request.
    pub fn get(&self, project: &str, zone: &str) -> InstanceSettingGetCall<'a, S> {
    ...
    pub fn patch(&self, request: InstanceSettings, project: &str, zone: &str) -> InstanceSettingPatchCall<'a, S> {
...
impl<'a, S> InstanceTemplateMethods<'a, S> {
    ...
    ///
    /// * `project` - Name of the project scoping this request.
    pub fn aggregated_list(&self, project: &str) -> InstanceTemplateAggregatedListCall<'a, S> {
...
impl<'a, S> InstanceMethods<'a, S> {
    ...
    pub fn simulate_maintenance_event(&self, project: &str, zone: &str, instance: &str) -> InstanceSimulateMaintenanceEventCall<'a, S> {
        InstanceSimulateMaintenanceEventCall {
            ...
            _zone: zone.to_string(),
            _instance: instance.to_string(),
            _with_extended_notifications: Default::default(),
            _request_id: Default::default(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
...
/// A builder providing access to all methods supported on *instantSnapshot* resources.
/// It is not used directly, but through the [`Compute`] hub.
///
/// # Example
///
...
/// let mut hub = Compute::new(hyper::Client::builder().build(hyper_rustls::HttpsConnectorBuilder::new().with_native_roots().unwrap().https_or_http().enable_http1().build()), auth);
/// // Usually you wouldn't bind this to a variable, but keep calling *CallBuilders*
/// // like `aggregated_list(...)`, `delete(...)`, `get(...)`, `get_iam_policy(...)`, `insert(...)`, `list(...)`, `set_iam_policy(...)`, `set_labels(...)` and `test_iam_permissions(...)`
/// // to build up your call.
/// let rb = hub.instant_snapshots();
/// # }
/// ```
pub struct InstantSnapshotMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Compute<S>,
}

impl<'a, S> client::MethodsBuilder for InstantSnapshotMethods<'a, S> {}

impl<'a, S> InstantSnapshotMethods<'a, S> {
    ...
    ///
    /// * `project` - Project ID for this request.
    pub fn aggregated_list(&self, project: &str) -> InstantSnapshotAggregatedListCall<'a, S> {
    ...
    pub fn delete(&self, project: &str, zone: &str, instant_snapshot: &str) -> InstantSnapshotDeleteCall<'a, S> {
        InstantSnapshotDeleteCall {
            hub: self.hub,
            _project: project.to_string(),
            _zone: zone.to_string(),
            _instant_snapshot: instant_snapshot.to_string(),
            _request_id: Default::default(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
    ...
    pub fn get(&self, project: &str, zone: &str, instant_snapshot: &str) -> InstantSnapshotGetCall<'a, S> {
    ...
    /// * `zone` - The name of the zone for this request.
    /// * `resource` - Name or id of the resource for this request.
    pub fn get_iam_policy(&self, project: &str, zone: &str, resource: &str) -> InstantSnapshotGetIamPolicyCall<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `zone` - Name of the zone for this request.
    pub fn insert(&self, request: InstantSnapshot, project: &str, zone: &str) -> InstantSnapshotInsertCall<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `zone` - The name of the zone for this request.
    pub fn list(&self, project: &str, zone: &str) -> InstantSnapshotListCall<'a, S> {
    ...
    /// * `zone` - The name of the zone for this request.
    /// * `resource` - Name or id of the resource for this request.
    pub fn set_iam_policy(&self, request: ZoneSetPolicyRequest, project: &str, zone: &str, resource: &str) -> InstantSnapshotSetIamPolicyCall<'a, S> {
    ...
    /// * `zone` - The name of the zone for this request.
    /// * `resource` - Name or id of the resource for this request.
    pub fn set_labels(&self, request: ZoneSetLabelsRequest, project: &str, zone: &str, resource: &str) -> InstantSnapshotSetLabelCall<'a, S> {
    ...
    /// * `zone` - The name of the zone for this request.
    /// * `resource` - Name or id of the resource for this request.
    pub fn test_iam_permissions(&self, request: TestPermissionsRequest, project: &str, zone: &str, resource: &str) -> InstantSnapshotTestIamPermissionCall<'a, S> {
...
/// A builder providing access to all methods supported on *interconnectRemoteLocation* resources.
/// It is not used directly, but through the [`Compute`] hub.
///
/// # Example
///
...
/// // like `get(...)` and `list(...)`
/// // to build up your call.
/// let rb = hub.interconnect_remote_locations();
/// # }
/// ```
pub struct InterconnectRemoteLocationMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Compute<S>,
}

impl<'a, S> client::MethodsBuilder for InterconnectRemoteLocationMethods<'a, S> {}

impl<'a, S> InterconnectRemoteLocationMethods<'a, S> {
    ...
    ///
    /// * `project` - Project ID for this request.
    /// * `interconnectRemoteLocation` - Name of the interconnect remote location to return.
    pub fn get(&self, project: &str, interconnect_remote_location: &str) -> InterconnectRemoteLocationGetCall<'a, S> {
        InterconnectRemoteLocationGetCall {
            hub: self.hub,
            _project: project.to_string(),
            _interconnect_remote_location: interconnect_remote_location.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
        }
    ...
    ///
    /// * `project` - Project ID for this request.
    pub fn list(&self, project: &str) -> InterconnectRemoteLocationListCall<'a, S> {
...
impl<'a, S> NetworkAttachmentMethods<'a, S> {
    ...
    pub fn patch(&self, request: NetworkAttachment, project: &str, region: &str, network_attachment: &str) -> NetworkAttachmentPatchCall<'a, S> {
...
impl<'a, S> ProjectMethods<'a, S> {
    ...
    /// * `request` - No description provided.
    /// * `project` - Project ID for this request.
    pub fn set_cloud_armor_tier(&self, request: ProjectsSetCloudArmorTierRequest, project: &str) -> ProjectSetCloudArmorTierCall<'a, S> {
...
/// let mut hub = Compute::new(hyper::Client::builder().build(hyper_rustls::HttpsConnectorBuilder::new().with_native_roots().unwrap().https_or_http().enable_http1().build()), auth);
/// // Usually you wouldn't bind this to a variable, but keep calling *CallBuilders*
/// // like `announce(...)`, `delete(...)`, `get(...)`, `insert(...)`, `list(...)`, `patch(...)` and `withdraw(...)`
/// // to build up your call.
...
impl<'a, S> PublicAdvertisedPrefixMethods<'a, S> {
    ...
    pub fn announce(&self, project: &str, public_advertised_prefix: &str) -> PublicAdvertisedPrefixAnnounceCall<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `publicAdvertisedPrefix` - The name of the public advertised prefix. It should comply with RFC1035.
    pub fn withdraw(&self, project: &str, public_advertised_prefix: &str) -> PublicAdvertisedPrefixWithdrawCall<'a, S> {
...
/// let mut hub = Compute::new(hyper::Client::builder().build(hyper_rustls::HttpsConnectorBuilder::new().with_native_roots().unwrap().https_or_http().enable_http1().build()), auth);
/// // Usually you wouldn't bind this to a variable, but keep calling *CallBuilders*
/// // like `aggregated_list(...)`, `announce(...)`, `delete(...)`, `get(...)`, `insert(...)`, `list(...)`, `patch(...)` and `withdraw(...)`
/// // to build up your call.
...
impl<'a, S> PublicDelegatedPrefixMethods<'a, S> {
    ...
    pub fn announce(&self, project: &str, region: &str, public_delegated_prefix: &str) -> PublicDelegatedPrefixAnnounceCall<'a, S> {
    ...
    /// * `region` - The name of the region where the public delegated prefix is located. It should comply with RFC1035.
    /// * `publicDelegatedPrefix` - The name of the public delegated prefix. It should comply with RFC1035.
    pub fn withdraw(&self, project: &str, region: &str, public_delegated_prefix: &str) -> PublicDelegatedPrefixWithdrawCall<'a, S> {
...
impl<'a, S> RegionDiskMethods<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `region` - The name of the region for this request.
    pub fn bulk_insert(&self, request: BulkInsertDiskResource, project: &str, region: &str) -> RegionDiskBulkInsertCall<'a, S> {
    ...
    /// * `region` - The name of the region for this request.
    /// * `disk` - The name of the persistent disk.
    pub fn start_async_replication(&self, request: RegionDisksStartAsyncReplicationRequest, project: &str, region: &str, disk: &str) -> RegionDiskStartAsyncReplicationCall<'a, S> {
    ...
    /// * `region` - The name of the region for this request.
    /// * `disk` - The name of the persistent disk.
    pub fn stop_async_replication(&self, project: &str, region: &str, disk: &str) -> RegionDiskStopAsyncReplicationCall<'a, S> {
    ...
    pub fn stop_group_async_replication(&self, request: DisksStopGroupAsyncReplicationResource, project: &str, region: &str) -> RegionDiskStopGroupAsyncReplicationCall<'a, S> {
    ...
    /// * `region` - The name of the region for this request.
    /// * `disk` - The disk name for this request.
    pub fn update(&self, request: Disk, project: &str, region: &str, disk: &str) -> RegionDiskUpdateCall<'a, S> {
...
/// A builder providing access to all methods supported on *regionInstanceTemplate* resources.
/// It is not used directly, but through the [`Compute`] hub.
///
/// # Example
///
...
/// // to build up your call.
/// let rb = hub.region_instance_templates();
/// # }
/// ```
pub struct RegionInstanceTemplateMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Compute<S>,
}

impl<'a, S> client::MethodsBuilder for RegionInstanceTemplateMethods<'a, S> {}

impl<'a, S> RegionInstanceTemplateMethods<'a, S> {
    ...
    /// * `region` - The name of the region for this request.
    /// * `instanceTemplate` - The name of the instance template to delete.
    pub fn delete(&self, project: &str, region: &str, instance_template: &str) -> RegionInstanceTemplateDeleteCall<'a, S> {
    ...
    /// * `region` - The name of the region for this request.
    /// * `instanceTemplate` - The name of the instance template.
    pub fn get(&self, project: &str, region: &str, instance_template: &str) -> RegionInstanceTemplateGetCall<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `region` - The name of the region for this request.
    pub fn insert(&self, request: InstanceTemplate, project: &str, region: &str) -> RegionInstanceTemplateInsertCall<'a, S> {
    ...
    pub fn list(&self, project: &str, region: &str) -> RegionInstanceTemplateListCall<'a, S> {
...
impl<'a, S> client::MethodsBuilder for RegionInstantSnapshotMethods<'a, S> {}
...
impl<'a, S> RegionNetworkEndpointGroupMethods<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `region` - The name of the region where the network endpoint group is located. It should comply with RFC1035.
    /// * `networkEndpointGroup` - The name of the network endpoint group you are detaching network endpoints from. It should comply with RFC1035.
...
impl<'a, S> RegionSecurityPolicyMethods<'a, S> {
    ...
    pub fn add_rule(&self, request: SecurityPolicyRule, project: &str, region: &str, security_policy: &str) -> RegionSecurityPolicyAddRuleCall<'a, S> {
    ...
    pub fn get_rule(&self, project: &str, region: &str, security_policy: &str) -> RegionSecurityPolicyGetRuleCall<'a, S> {
    ...
    /// * `region` - Name of the region scoping this request.
    /// * `securityPolicy` - Name of the security policy to update.
    pub fn patch_rule(&self, request: SecurityPolicyRule, project: &str, region: &str, security_policy: &str) -> RegionSecurityPolicyPatchRuleCall<'a, S> {
    ...
    /// * `region` - Name of the region scoping this request.
    /// * `securityPolicy` - Name of the security policy to update.
    pub fn remove_rule(&self, project: &str, region: &str, security_policy: &str) -> RegionSecurityPolicyRemoveRuleCall<'a, S> {
...
/// A builder providing access to all methods supported on *regionZone* resources.
/// It is not used directly, but through the [`Compute`] hub.
///
/// # Example
///
...
/// // like `list(...)`
/// // to build up your call.
/// let rb = hub.region_zones();
/// # }
/// ```
pub struct RegionZoneMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Compute<S>,
}

impl<'a, S> client::MethodsBuilder for RegionZoneMethods<'a, S> {}

impl<'a, S> RegionZoneMethods<'a, S> {
    ...
    pub fn list(&self, project: &str, region: &str) -> RegionZoneListCall<'a, S> {
        RegionZoneListCall {
            hub: self.hub,
            _project: project.to_string(),
            _region: region.to_string(),
...
impl<'a, S> RouterMethods<'a, S> {
    ...
    pub fn get_router_status(&self, project: &str, region: &str, router: &str) -> RouterGetRouterStatusCall<'a, S> {
        RouterGetRouterStatusCall {
            hub: self.hub,
            _project: project.to_string(),
            _region: region.to_string(),
            _router: router.to_string(),
...
/// A builder providing access to all methods supported on *snapshotSetting* resources.
/// It is not used directly, but through the [`Compute`] hub.
///
/// # Example
///
...
/// // like `get(...)` and `patch(...)`
/// // to build up your call.
/// let rb = hub.snapshot_settings();
/// # }
/// ```
pub struct SnapshotSettingMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Compute<S>,
}

impl<'a, S> client::MethodsBuilder for SnapshotSettingMethods<'a, S> {}

impl<'a, S> SnapshotSettingMethods<'a, S> {
    ...
    ///
    /// * `project` - Project ID for this request.
    pub fn get(&self, project: &str) -> SnapshotSettingGetCall<'a, S> {
    ...
    /// * `request` - No description provided.
    /// * `project` - Project ID for this request.
    pub fn patch(&self, request: SnapshotSettings, project: &str) -> SnapshotSettingPatchCall<'a, S> {
...
/// A builder providing access to all methods supported on *storagePoolType* resources.
/// It is not used directly, but through the [`Compute`] hub.
///
/// # Example
///
...
/// // like `aggregated_list(...)`, `get(...)` and `list(...)`
/// // to build up your call.
/// let rb = hub.storage_pool_types();
/// # }
/// ```
pub struct StoragePoolTypeMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Compute<S>,
}

impl<'a, S> client::MethodsBuilder for StoragePoolTypeMethods<'a, S> {}

impl<'a, S> StoragePoolTypeMethods<'a, S> {
    ...
    ///
    /// * `project` - Project ID for this request.
    pub fn aggregated_list(&self, project: &str) -> StoragePoolTypeAggregatedListCall<'a, S> {
    ...
    pub fn get(&self, project: &str, zone: &str, storage_pool_type: &str) -> StoragePoolTypeGetCall<'a, S> {
        StoragePoolTypeGetCall {
            hub: self.hub,
            _project: project.to_string(),
            _zone: zone.to_string(),
            _storage_pool_type: storage_pool_type.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
        }
    ...
    /// * `project` - Project ID for this request.
    /// * `zone` - The name of the zone for this request.
    pub fn list(&self, project: &str, zone: &str) -> StoragePoolTypeListCall<'a, S> {
...
/// # }
/// ```
pub struct StoragePoolMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Compute<S>,
}

impl<'a, S> client::MethodsBuilder for StoragePoolMethods<'a, S> {}

impl<'a, S> StoragePoolMethods<'a, S> {
    ...
    ///
    /// * `project` - Project ID for this request.
    pub fn aggregated_list(&self, project: &str) -> StoragePoolAggregatedListCall<'a, S> {
    ...
    pub fn delete(&self, project: &str, zone: &str, storage_pool: &str) -> StoragePoolDeleteCall<'a, S> {
        StoragePoolDeleteCall {
            hub: self.hub,
            _project: project.to_string(),
            _zone: zone.to_string(),
            _storage_pool: storage_pool.to_string(),
            _request_id: Default::default(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
    ...
    pub fn get(&self, project: &str, zone: &str, storage_pool: &str) -> StoragePoolGetCall<'a, S> {
        StoragePoolGetCall {
            hub: self.hub,
            _project: project.to_string(),
            _zone: zone.to_string(),
    ...
    /// * `zone` - The name of the zone for this request.
    /// * `resource` - Name or id of the resource for this request.
    pub fn get_iam_policy(&self, project: &str, zone: &str, resource: &str) -> StoragePoolGetIamPolicyCall<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `zone` - The name of the zone for this request.
    pub fn insert(&self, request: StoragePool, project: &str, zone: &str) -> StoragePoolInsertCall<'a, S> {
    ...
    /// * `project` - Project ID for this request.
    /// * `zone` - The name of the zone for this request.
    pub fn list(&self, project: &str, zone: &str) -> StoragePoolListCall<'a, S> {
        StoragePoolListCall {
            hub: self.hub,
            _project: project.to_string(),
            _zone: zone.to_string(),
    ...
    pub fn list_disks(&self, project: &str, zone: &str, storage_pool: &str) -> StoragePoolListDiskCall<'a, S> {
    ...
    /// * `zone` - The name of the zone for this request.
    /// * `resource` - Name or id of the resource for this request.
    pub fn set_iam_policy(&self, request: ZoneSetPolicyRequest, project: &str, zone: &str, resource: &str) -> StoragePoolSetIamPolicyCall<'a, S> {
    ...
    /// * `zone` - The name of the zone for this request.
    /// * `resource` - Name or id of the resource for this request.
    pub fn test_iam_permissions(&self, request: TestPermissionsRequest, project: &str, zone: &str, resource: &str) -> StoragePoolTestIamPermissionCall<'a, S> {
    ...
    pub fn update(&self, request: StoragePool, project: &str, zone: &str, storage_pool: &str) -> StoragePoolUpdateCall<'a, S> {
...
impl<'a, S> TargetPoolMethods<'a, S> {
    ...
    pub fn set_security_policy(&self, request: SecurityPolicyReference, project: &str, region: &str, target_pool: &str) -> TargetPoolSetSecurityPolicyCall<'a, S> {
...
impl<'a, S> VpnGatewayMethods<'a, S> {
    ...
    /// * `region` - Name of the region for this request.
    /// * `vpnGateway` - Name of the VPN gateway to return.
    pub fn get_status(&self, project: &str, region: &str, vpn_gateway: &str) -> VpnGatewayGetStatusCall<'a, S> {
        VpnGatewayGetStatusCall {
            hub: self.hub,
            _project: project.to_string(),
            _region: region.to_string(),
            _vpn_gateway: vpn_gateway.to_string(),
