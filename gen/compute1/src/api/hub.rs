...
impl<'a, S> Compute<S> {
    ...
    pub fn instance_group_manager_resize_requests(&'a self) -> InstanceGroupManagerResizeRequestMethods<'a, S> {
        InstanceGroupManagerResizeRequestMethods { hub: &self }
    }
    ...
    pub fn instance_settings(&'a self) -> InstanceSettingMethods<'a, S> {
        InstanceSettingMethods { hub: &self }
    }
    ...
    pub fn instant_snapshots(&'a self) -> InstantSnapshotMethods<'a, S> {
        InstantSnapshotMethods { hub: &self }
    }
    ...
    pub fn interconnect_remote_locations(&'a self) -> InterconnectRemoteLocationMethods<'a, S> {
        InterconnectRemoteLocationMethods { hub: &self }
    }
    ...
    pub fn region_instance_templates(&'a self) -> RegionInstanceTemplateMethods<'a, S> {
        RegionInstanceTemplateMethods { hub: &self }
    }
    ...
    pub fn region_instant_snapshots(&'a self) -> RegionInstantSnapshotMethods<'a, S> {
        RegionInstantSnapshotMethods { hub: &self }
    }
    ...
    pub fn snapshot_settings(&'a self) -> SnapshotSettingMethods<'a, S> {
        SnapshotSettingMethods { hub: &self }
    }
    ...
    pub fn storage_pool_types(&'a self) -> StoragePoolTypeMethods<'a, S> {
        StoragePoolTypeMethods { hub: &self }
    }
    pub fn storage_pools(&'a self) -> StoragePoolMethods<'a, S> {
        StoragePoolMethods { hub: &self }
    }
