...
pub struct ProjectSiteCustomDomainCreateCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseHosting<S>,
   pub(super) _request: CustomDomain,
   pub(super) _parent: String,
   pub(super) _validate_only: Option<bool>,
   pub(super) _custom_domain_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ProjectSiteCustomDomainUndeleteCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseHosting<S>,
   pub(super) _request: UndeleteCustomDomainRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
///              .status(&ProjectStatusEnum::STATUSUNSPECIFIED)
///              .page_token("diam")
///              .page_size(-61)
///              .doit().await;
/// # }
...
///              .status(&SiteStatusEnum::STATUSUNSPECIFIED)
