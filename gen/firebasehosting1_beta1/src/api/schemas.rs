...
pub struct Certificate {
    ...
    pub state: Option<CertificateStateEnum>,
    /// Output only. The certificate's type.
    #[serde(rename="type")]
    
    pub type_: Option<CertificateTypeEnum>,
...
pub struct CustomDomain {
    ...
    pub cert_preference: Option<CustomDomainCertPreferenceEnum>,
    ...
    pub host_state: Option<CustomDomainHostStateEnum>,
    ...
    pub ownership_state: Option<CustomDomainOwnershipStateEnum>,
...
pub struct DnsRecord {
    ...
    pub required_action: Option<DnsRecordRequiredActionEnum>,
    /// Output only. The record's type, which determines what data the record contains.
    #[serde(rename="type")]
    
    pub type_: Option<DnsRecordTypeEnum>,
}
