...
pub struct BeaconinfoGetforobservedCall<'a, S>
   ...
   pub(super) _request: GetInfoForObservedBeaconsRequest,
...
pub struct BeaconAttachmentBatchDeleteCall<'a, S>
   ...
   pub(super) hub: &'a Proximitybeacon<S>,
   pub(super) _beacon_name: String,
   pub(super) _project_id: Option<String>,
   pub(super) _namespaced_type: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct BeaconAttachmentCreateCall<'a, S>
   ...
   pub(super) hub: &'a Proximitybeacon<S>,
   pub(super) _request: BeaconAttachment,
   pub(super) _beacon_name: String,
   pub(super) _project_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct BeaconAttachmentDeleteCall<'a, S>
   ...
   pub(super) hub: &'a Proximitybeacon<S>,
   pub(super) _attachment_name: String,
   pub(super) _project_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct NamespaceUpdateCall<'a, S>
   ...
   pub(super) hub: &'a Proximitybeacon<S>,
   pub(super) _request: Namespace,
   pub(super) _namespace_name: String,
   pub(super) _project_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
