...
pub struct ProjectLocationConversionWorkspaceMappingRuleCreateCall<'a, S>
   ...
   pub(super) hub: &'a DatabaseMigrationService<S>,
   pub(super) _request: MappingRule,
   pub(super) _parent: String,
   pub(super) _request_id: Option<String>,
   pub(super) _mapping_rule_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
///              .view(&ProjectViewEnum::DATABASEENTITYVIEWUNSPECIFIED)
///              .uncommitted(true)
///              .tree(&ProjectTreeEnum::DBTREETYPEUNSPECIFIED)
///              .page_token("ipsum")
///              .page_size(-23)
///              .filter("takimata")
///              .commit_id("consetetur")
///              .doit().await;
/// # }
/// ```
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub fn view(mut self, new_value: &ProjectViewEnum) -> ProjectLocationConversionWorkspaceDescribeDatabaseEntityCall<'a, S> {
...
pub struct ProjectLocationMigrationJobDemoteDestinationCall<'a, S>
   ...
   pub(super) hub: &'a DatabaseMigrationService<S>,
   pub(super) _request: DemoteDestinationRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationMigrationJobGenerateTcpProxyScriptCall<'a, S>
   ...
   pub(super) hub: &'a DatabaseMigrationService<S>,
   pub(super) _request: GenerateTcpProxyScriptRequest,
   pub(super) _migration_job: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
///              .options_requested_policy_version(-82)
///              .doit().await;
/// # }
/// ```
