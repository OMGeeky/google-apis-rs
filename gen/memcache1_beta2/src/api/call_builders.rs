...
pub struct ProjectLocationInstanceApplyParameterCall<'a, S>
   ...
   pub(super) _request: ApplyParametersRequest,
...
pub struct ProjectLocationInstanceApplySoftwareUpdateCall<'a, S>
   ...
   pub(super) hub: &'a CloudMemorystoreForMemcached<S>,
   pub(super) _request: ApplySoftwareUpdateRequest,
...
pub struct ProjectLocationInstanceUpdateParameterCall<'a, S>
   ...
   pub(super) hub: &'a CloudMemorystoreForMemcached<S>,
   pub(super) _request: UpdateParametersRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationInstanceUpgradeCall<'a, S>
   ...
   pub(super) hub: &'a CloudMemorystoreForMemcached<S>,
   pub(super) _request: GoogleCloudMemcacheV1beta2UpgradeInstanceRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "memcache.projects.locations.instances.upgrade",
                               http_method: hyper::Method::POST });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleCloudMemcacheV1beta2UpgradeInstanceRequest) -> ProjectLocationInstanceUpgradeCall<'a, S> {
        self._request = new_value;
        self
    }
