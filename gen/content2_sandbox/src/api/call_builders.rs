...
/// use content2_sandbox::api::enums::*;
/// # async fn dox() {
...
pub struct OrderinvoiceCreatechargeinvoiceCall<'a, S>
   ...
   pub(super) _request: OrderinvoicesCreateChargeInvoiceRequest,
...
pub struct OrderinvoiceCreaterefundinvoiceCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrderinvoicesCreateRefundInvoiceRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderpaymentNotifyauthapprovedCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrderpaymentsNotifyAuthApprovedRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderpaymentNotifyauthdeclinedCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrderpaymentsNotifyAuthDeclinedRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderpaymentNotifychargeCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrderpaymentsNotifyChargeRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderpaymentNotifyrefundCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrderpaymentsNotifyRefundRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
///              .page_token("Lorem")
///              .order_by(&OrderreturnOrderByEnum::ReturnCreationTimeAsc)
///              .max_results(76)
...
pub struct OrderAcknowledgeCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersAcknowledgeRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderCancelCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersCancelRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderCancellineitemCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersCancelLineItemRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderCanceltestorderbycustomerCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersCancelTestOrderByCustomerRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderCreatetestorderCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersCreateTestOrderRequest,
   pub(super) _merchant_id: u64,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct OrderCreatetestreturnCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersCreateTestReturnRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderCustombatchCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersCustomBatchRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct OrderGetbymerchantorderidCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _merchant_id: u64,
   pub(super) _merchant_order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct OrderInstorerefundlineitemCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersInStoreRefundLineItemRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
///              .page_token("dolor")
///              .order_by(&OrderOrderByEnum::PlacedDateAsc)
///              .max_results(81)
///              .acknowledged(false)
///              .doit().await;
/// # }
...
pub struct OrderRefundCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersRefundRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderRejectreturnlineitemCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersRejectReturnLineItemRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderReturnlineitemCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersReturnLineItemRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderReturnrefundlineitemCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersReturnRefundLineItemRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderSetlineitemmetadataCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersSetLineItemMetadataRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderShiplineitemCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersShipLineItemsRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderUpdatelineitemshippingdetailCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersUpdateLineItemShippingDetailsRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderUpdatemerchantorderidCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersUpdateMerchantOrderIdRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct OrderUpdateshipmentCall<'a, S>
   ...
   pub(super) hub: &'a ShoppingContent<S>,
   pub(super) _request: OrdersUpdateShipmentRequest,
   pub(super) _merchant_id: u64,
   pub(super) _order_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
