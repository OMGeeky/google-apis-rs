...
pub struct CourseAliasCreateCall<'a, S>
   ...
   pub(super) _request: CourseAlias,
...
pub struct CourseAnnouncementCreateCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: Announcement,
   pub(super) _course_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
///              .page_size(-57)
///              .order_by("ipsum")
///              .add_announcement_states(&CourseAnnouncementStatesEnum::ANNOUNCEMENTSTATEUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
...
pub struct CourseAnnouncementModifyAssigneeCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: ModifyAnnouncementAssigneesRequest,
   pub(super) _course_id: String,
   pub(super) _id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct CourseCourseWorkStudentSubmissionModifyAttachmentCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: ModifyAttachmentsRequest,
   pub(super) _course_id: String,
   pub(super) _course_work_id: String,
   pub(super) _id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct CourseCourseWorkStudentSubmissionPatchCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: StudentSubmission,
   pub(super) _course_id: String,
   pub(super) _course_work_id: String,
   pub(super) _id: String,
   pub(super) _update_mask: Option<client::FieldMask>,
...
pub struct CourseCourseWorkStudentSubmissionReclaimCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: ReclaimStudentSubmissionRequest,
   pub(super) _course_id: String,
   pub(super) _course_work_id: String,
   pub(super) _id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct CourseCourseWorkStudentSubmissionReturnCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: ReturnStudentSubmissionRequest,
   pub(super) _course_id: String,
   pub(super) _course_work_id: String,
   pub(super) _id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct CourseCourseWorkStudentSubmissionTurnInCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: TurnInStudentSubmissionRequest,
   pub(super) _course_id: String,
   pub(super) _course_work_id: String,
   pub(super) _id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
///              .page_size(-20)
///              .order_by("vero")
///              .add_course_work_states(&CourseCourseWorkStatesEnum::COURSEWORKSTATEUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
...
pub struct CourseCourseWorkModifyAssigneeCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: ModifyCourseWorkAssigneesRequest,
   pub(super) _course_id: String,
   pub(super) _id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct CourseCourseWorkMaterialCreateCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: CourseWorkMaterial,
   pub(super) _course_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
///              .add_course_work_material_states(&CourseCourseWorkMaterialStatesEnum::COURSEWORKMATERIALSTATEUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
...
pub struct CourseStudentCreateCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: Student,
   pub(super) _course_id: String,
   pub(super) _enrollment_code: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
///              .page_token("dolores")
///              .page_size(-69)
///              .add_course_states(&CourseCourseStatesEnum::COURSESTATEUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
pub struct CourseListCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _teacher_id: Option<String>,
...
pub struct InvitationListCall<'a, S>
   ...
   pub(super) _page_token: Option<String>,
   pub(super) _page_size: Option<i32>,
   pub(super) _course_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct RegistrationDeleteCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _registration_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct UserProfileGuardianInvitationCreateCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _request: GuardianInvitation,
...
pub struct UserProfileGuardianInvitationGetCall<'a, S>
   ...
   pub(super) hub: &'a Classroom<S>,
   pub(super) _student_id: String,
   pub(super) _invitation_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
///              .add_states(&UserProfileStatesEnum::GUARDIANINVITATIONSTATEUNSPECIFIED)
///              .page_token("aliquyam")
///              .page_size(-47)
