...
The [delegate trait](https://docs.rs/google-classroom1/5.0.5+20240415/google_classroom1/client::Delegate) is default-implemented, allowing you to customize it with minimal effort.
