...
pub struct ExamStatus {
    ...
    pub exam_type: Option<ExamStatusExamTypeEnum>,
...
pub struct CertificationStatus {
    ...
    pub type_: Option<CertificationStatusTypeEnum>,
...
pub struct SpecializationStatus {
    ...
    pub badge_specialization: Option<SpecializationStatusBadgeSpecializationEnum>,
    /// State of agency specialization.
    #[serde(rename="badgeSpecializationState")]
    
    pub badge_specialization_state: Option<SpecializationStatusBadgeSpecializationStateEnum>,
}
...
pub struct CertificationExamStatus {
    ...
    pub type_: Option<CertificationExamStatusTypeEnum>,
}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [get partnersstatus](MethodGetPartnersstatusCall) (response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
