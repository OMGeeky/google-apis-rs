...
The [delegate trait](https://docs.rs/google-connectors1/5.0.5+20240415/google_connectors1/client::Delegate) is default-implemented, allowing you to customize it with minimal effort.
