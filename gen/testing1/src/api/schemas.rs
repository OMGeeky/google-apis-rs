...
pub struct DeviceSession {
    ...
    pub state: Option<DeviceSessionStateEnum>,
...
pub struct PerAndroidVersionInfo {
    ...
    pub device_capacity: Option<PerAndroidVersionInfoDeviceCapacityEnum>,
...
pub struct PerIosVersionInfo {
    ...
    pub device_capacity: Option<PerIosVersionInfoDeviceCapacityEnum>,
    /// An iOS version.
    #[serde(rename="versionId")]
...
pub struct SessionStateEvent {
    ...
    pub session_state: Option<SessionStateEventSessionStateEnum>,
