...
///              .view(&ProjectViewEnum::CRYPTOKEYVERSIONVIEWUNSPECIFIED)
...
pub struct ProjectLocationKeyRingCryptoKeyCryptoKeyVersionRawDecryptCall<'a, S>
   ...
   pub(super) hub: &'a CloudKMS<S>,
   pub(super) _request: RawDecryptRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationKeyRingCryptoKeyCryptoKeyVersionRawEncryptCall<'a, S>
   ...
   pub(super) hub: &'a CloudKMS<S>,
   pub(super) _request: RawEncryptRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
///              .version_view(&ProjectVersionViewEnum::CRYPTOKEYVERSIONVIEWUNSPECIFIED)
///              .page_token("et")
///              .page_size(-28)
///              .order_by("amet.")
///              .filter("consetetur")
