...
pub struct PlatformPropertyIdeaActivityCreateCall<'a, S>
   ...
   pub(super) _request: GoogleSearchIdeahubV1betaIdeaActivity,
...
pub struct PlatformPropertyIdeaStatePatchCall<'a, S>
   ...
   pub(super) hub: &'a Ideahub<S>,
   pub(super) _request: GoogleSearchIdeahubV1betaIdeaState,
...
pub struct PlatformPropertyTopicStatePatchCall<'a, S>
   ...
   pub(super) hub: &'a Ideahub<S>,
   pub(super) _request: GoogleSearchIdeahubV1betaTopicState,
   pub(super) _name: String,
   pub(super) _update_mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
