...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/ideahub1_beta).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](Ideahub) ...
//! 
//! * platforms
//!  * [*properties idea activities create*](api::PlatformPropertyIdeaActivityCreateCall), [*properties idea states patch*](api::PlatformPropertyIdeaStatePatchCall), [*properties ideas list*](api::PlatformPropertyIdeaListCall), [*properties locales list*](api::PlatformPropertyLocaleListCall) and [*properties topic states patch*](api::PlatformPropertyTopicStatePatchCall)
//! 
//! 
//! 
//! 
