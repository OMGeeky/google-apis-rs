...
pub struct FindNearest {
    ...
    pub distance_measure: Option<FindNearestDistanceMeasureEnum>,
...
pub struct GoogleFirestoreAdminV1Backup {
    ...
    pub state: Option<GoogleFirestoreAdminV1BackupStateEnum>,
...
pub struct GoogleFirestoreAdminV1Database {
    ...
    pub delete_protection_state: Option<GoogleFirestoreAdminV1DatabaseDeleteProtectionStateEnum>,
    ...
    pub point_in_time_recovery_enablement: Option<GoogleFirestoreAdminV1DatabasePointInTimeRecoveryEnablementEnum>,
...
pub struct GoogleFirestoreAdminV1WeeklyRecurrence {
    ...
    pub day: Option<GoogleFirestoreAdminV1WeeklyRecurrenceDayEnum>,
}
