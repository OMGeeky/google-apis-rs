...
pub struct ManagedShortLinkCreateCall<'a, S>
   ...
   pub(super) _request: CreateManagedShortLinkRequest,
...
pub struct ShortLinkCreateCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseDynamicLinks<S>,
   pub(super) _request: CreateShortDynamicLinkRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MethodGetLinkStatCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseDynamicLinks<S>,
   pub(super) _dynamic_link: String,
   pub(super) _sdk_version: Option<String>,
   pub(super) _duration_days: Option<i64>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MethodInstallAttributionCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseDynamicLinks<S>,
   pub(super) _request: GetIosPostInstallAttributionRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MethodReopenAttributionCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseDynamicLinks<S>,
   pub(super) _request: GetIosReopenAttributionRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
