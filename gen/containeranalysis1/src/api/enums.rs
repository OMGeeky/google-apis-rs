...
// region CisBenchmarkSeverityEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
pub enum CisBenchmarkSeverityEnum {
...
impl AsRef<str> for CisBenchmarkSeverityEnum {
    fn as_ref(&self) -> &str {
        match *self {
            CisBenchmarkSeverityEnum::SEVERITYUNSPECIFIED => "SEVERITY_UNSPECIFIED",
            CisBenchmarkSeverityEnum::MINIMAL => "MINIMAL",
            CisBenchmarkSeverityEnum::LOW => "LOW",
            CisBenchmarkSeverityEnum::MEDIUM => "MEDIUM",
            CisBenchmarkSeverityEnum::HIGH => "HIGH",
            CisBenchmarkSeverityEnum::CRITICAL => "CRITICAL",
        }
    }
}

impl std::convert::TryFrom< &str> for CisBenchmarkSeverityEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "SEVERITY_UNSPECIFIED" => Ok(CisBenchmarkSeverityEnum::SEVERITYUNSPECIFIED),
           "MINIMAL" => Ok(CisBenchmarkSeverityEnum::MINIMAL),
           "LOW" => Ok(CisBenchmarkSeverityEnum::LOW),
           "MEDIUM" => Ok(CisBenchmarkSeverityEnum::MEDIUM),
           "HIGH" => Ok(CisBenchmarkSeverityEnum::HIGH),
           "CRITICAL" => Ok(CisBenchmarkSeverityEnum::CRITICAL),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a CisBenchmarkSeverityEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
// region DiscoveryNoteAnalysisKindEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
/// Required. Immutable. The kind of analysis that is handled by this discovery.
pub enum DiscoveryNoteAnalysisKindEnum {
...
impl AsRef<str> for DiscoveryNoteAnalysisKindEnum {
    fn as_ref(&self) -> &str {
        match *self {
            ...
            DiscoveryNoteAnalysisKindEnum::VULNERABILITYASSESSMENT => "VULNERABILITY_ASSESSMENT",
            DiscoveryNoteAnalysisKindEnum::SBOMREFERENCE => "SBOM_REFERENCE",
        }
    }
}

impl std::convert::TryFrom< &str> for DiscoveryNoteAnalysisKindEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "NOTE_KIND_UNSPECIFIED" => Ok(DiscoveryNoteAnalysisKindEnum::NOTEKINDUNSPECIFIED),
           "VULNERABILITY" => Ok(DiscoveryNoteAnalysisKindEnum::VULNERABILITY),
           "BUILD" => Ok(DiscoveryNoteAnalysisKindEnum::BUILD),
           "IMAGE" => Ok(DiscoveryNoteAnalysisKindEnum::IMAGE),
           "PACKAGE" => Ok(DiscoveryNoteAnalysisKindEnum::PACKAGE),
           "DEPLOYMENT" => Ok(DiscoveryNoteAnalysisKindEnum::DEPLOYMENT),
           "DISCOVERY" => Ok(DiscoveryNoteAnalysisKindEnum::DISCOVERY),
           "ATTESTATION" => Ok(DiscoveryNoteAnalysisKindEnum::ATTESTATION),
           "UPGRADE" => Ok(DiscoveryNoteAnalysisKindEnum::UPGRADE),
           "COMPLIANCE" => Ok(DiscoveryNoteAnalysisKindEnum::COMPLIANCE),
           "DSSE_ATTESTATION" => Ok(DiscoveryNoteAnalysisKindEnum::DSSEATTESTATION),
           "VULNERABILITY_ASSESSMENT" => Ok(DiscoveryNoteAnalysisKindEnum::VULNERABILITYASSESSMENT),
           "SBOM_REFERENCE" => Ok(DiscoveryNoteAnalysisKindEnum::SBOMREFERENCE),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a DiscoveryNoteAnalysisKindEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
impl std::convert::TryFrom< &str> for NoteKindEnum {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           ...
           "UPGRADE" => Ok(NoteKindEnum::UPGRADE),
           "COMPLIANCE" => Ok(NoteKindEnum::COMPLIANCE),
           "DSSE_ATTESTATION" => Ok(NoteKindEnum::DSSEATTESTATION),
...
// region PackageNoteArchitectureEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
/// The CPU architecture for which packages in this distribution channel were built. Architecture will be blank for language packages.
pub enum PackageNoteArchitectureEnum {
...
impl AsRef<str> for PackageNoteArchitectureEnum {
    fn as_ref(&self) -> &str {
        match *self {
            PackageNoteArchitectureEnum::ARCHITECTUREUNSPECIFIED => "ARCHITECTURE_UNSPECIFIED",
            PackageNoteArchitectureEnum::X86 => "X86",
            PackageNoteArchitectureEnum::X64 => "X64",
        }
    }
}

impl std::convert::TryFrom< &str> for PackageNoteArchitectureEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "ARCHITECTURE_UNSPECIFIED" => Ok(PackageNoteArchitectureEnum::ARCHITECTUREUNSPECIFIED),
           "X86" => Ok(PackageNoteArchitectureEnum::X86),
           "X64" => Ok(PackageNoteArchitectureEnum::X64),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a PackageNoteArchitectureEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
// region VulnerabilityNoteCvssVersionEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
/// CVSS version used to populate cvss_score and severity.
pub enum VulnerabilityNoteCvssVersionEnum {
...
impl AsRef<str> for VulnerabilityNoteCvssVersionEnum {
    fn as_ref(&self) -> &str {
        match *self {
            VulnerabilityNoteCvssVersionEnum::CVSSVERSIONUNSPECIFIED => "CVSS_VERSION_UNSPECIFIED",
            VulnerabilityNoteCvssVersionEnum::CVSSVERSION2 => "CVSS_VERSION_2",
            VulnerabilityNoteCvssVersionEnum::CVSSVERSION3 => "CVSS_VERSION_3",
        }
    }
}

impl std::convert::TryFrom< &str> for VulnerabilityNoteCvssVersionEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "CVSS_VERSION_UNSPECIFIED" => Ok(VulnerabilityNoteCvssVersionEnum::CVSSVERSIONUNSPECIFIED),
           "CVSS_VERSION_2" => Ok(VulnerabilityNoteCvssVersionEnum::CVSSVERSION2),
           "CVSS_VERSION_3" => Ok(VulnerabilityNoteCvssVersionEnum::CVSSVERSION3),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a VulnerabilityNoteCvssVersionEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
// region VulnerabilityNoteSeverityEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
/// The note provider assigned severity of this vulnerability.
pub enum VulnerabilityNoteSeverityEnum {
...
impl AsRef<str> for VulnerabilityNoteSeverityEnum {
    fn as_ref(&self) -> &str {
        match *self {
            VulnerabilityNoteSeverityEnum::SEVERITYUNSPECIFIED => "SEVERITY_UNSPECIFIED",
            VulnerabilityNoteSeverityEnum::MINIMAL => "MINIMAL",
            VulnerabilityNoteSeverityEnum::LOW => "LOW",
            VulnerabilityNoteSeverityEnum::MEDIUM => "MEDIUM",
            VulnerabilityNoteSeverityEnum::HIGH => "HIGH",
            VulnerabilityNoteSeverityEnum::CRITICAL => "CRITICAL",
        }
    }
}

impl std::convert::TryFrom< &str> for VulnerabilityNoteSeverityEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "SEVERITY_UNSPECIFIED" => Ok(VulnerabilityNoteSeverityEnum::SEVERITYUNSPECIFIED),
           "MINIMAL" => Ok(VulnerabilityNoteSeverityEnum::MINIMAL),
           "LOW" => Ok(VulnerabilityNoteSeverityEnum::LOW),
           "MEDIUM" => Ok(VulnerabilityNoteSeverityEnum::MEDIUM),
           "HIGH" => Ok(VulnerabilityNoteSeverityEnum::HIGH),
           "CRITICAL" => Ok(VulnerabilityNoteSeverityEnum::CRITICAL),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a VulnerabilityNoteSeverityEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
