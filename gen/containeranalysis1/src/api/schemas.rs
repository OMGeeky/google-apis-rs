...
pub struct Assessment {
    ...
    pub state: Option<AssessmentStateEnum>,
...
pub struct CisBenchmark {
    ...
    pub severity: Option<CisBenchmarkSeverityEnum>,
}
...
pub struct DiscoveryNote {
    ...
    pub analysis_kind: Option<DiscoveryNoteAnalysisKindEnum>,
}
...
pub struct Justification {
    ...
    pub justification_type: Option<JustificationJustificationTypeEnum>,
}
...
pub struct PackageNote {
    ...
    pub architecture: Option<PackageNoteArchitectureEnum>,
...
pub struct Remediation {
    ...
    pub remediation_type: Option<RemediationRemediationTypeEnum>,
...
pub struct SBOMStatus {
    ...
    pub sbom_state: Option<SBOMStatusSbomStateEnum>,
}
...
pub struct VexAssessment {
    ...
    pub state: Option<VexAssessmentStateEnum>,
    /// The vulnerability identifier for this Assessment. Will hold one of common identifiers e.g. CVE, GHSA etc.
    #[serde(rename="vulnerabilityId")]
...
pub struct VulnerabilityNote {
    ...
    pub cvss_version: Option<VulnerabilityNoteCvssVersionEnum>,
    /// Details of all known distros and packages affected by this vulnerability.
    
    pub details: Option<Vec<Detail>>,
    /// The note provider assigned severity of this vulnerability.
    
    pub severity: Option<VulnerabilityNoteSeverityEnum>,
    /// The time this information was last changed at the source. This is an upstream timestamp from the underlying information source - e.g. Ubuntu security tracker.
    #[serde(rename="sourceUpdateTime")]
