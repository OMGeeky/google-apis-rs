...
pub struct Consent {
    ...
    pub ad_personalization: Option<ConsentAdPersonalizationEnum>,
    /// Represents consent for ad user data.
    #[serde(rename="adUserData")]
    
    pub ad_user_data: Option<ConsentAdUserDataEnum>,
}

impl client::Part for Consent {}
...
pub struct ExchangeReviewStatus {
    ...
    pub exchange: Option<ExchangeReviewStatusExchangeEnum>,
    /// Status of the exchange review.
    
    pub status: Option<ExchangeReviewStatusStatusEnum>,
}
...
pub struct GuaranteedOrderStatus {
    ...
    pub config_status: Option<GuaranteedOrderStatusConfigStatusEnum>,
    ...
    pub entity_status: Option<GuaranteedOrderStatusEntityStatusEnum>,
}
...
pub struct InventorySourceStatus {
    ...
    pub config_status: Option<InventorySourceStatusConfigStatusEnum>,
    ...
    pub entity_status: Option<InventorySourceStatusEntityStatusEnum>,
    ...
    pub seller_status: Option<InventorySourceStatusSellerStatusEnum>,
}
...
pub struct LineItem {
    ...
    /// The [optimized targeting](https://developers.google.com//support.google.com/displayvideo/answer/12060859) settings of the line item. This config is only applicable for display, video, or audio line items that use automated bidding and positively target eligible audience lists.
...
/// Settings that control the [optimized targeting](https://developers.google.com//support.google.com/displayvideo/answer/12060859) settings of the line item.
/// 
/// This type is not used in any activity, and only used as *part* of another schema.
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
pub struct User {
    ...
    pub last_login_time: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
