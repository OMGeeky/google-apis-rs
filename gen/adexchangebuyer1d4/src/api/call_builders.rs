...
pub struct AccountPatchCall<'a, S>
   ...
   pub(super) _id: i32,
   pub(super) _confirm_unsafe_account_change: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct CreativeAddDealCall<'a, S>
   ...
   pub(super) hub: &'a AdExchangeBuyer<S>,
   pub(super) _account_id: i32,
   pub(super) _buyer_creative_id: String,
   pub(super) _deal_id: i64,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MarketplacedealDeleteCall<'a, S>
   ...
   pub(super) hub: &'a AdExchangeBuyer<S>,
   pub(super) _request: DeleteOrderDealsRequest,
...
pub struct MarketplacedealInsertCall<'a, S>
   ...
   pub(super) hub: &'a AdExchangeBuyer<S>,
   pub(super) _request: AddOrderDealsRequest,
   pub(super) _proposal_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct MarketplacedealListCall<'a, S>
   ...
   pub(super) hub: &'a AdExchangeBuyer<S>,
   pub(super) _proposal_id: String,
   pub(super) _pql_query: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MarketplacedealUpdateCall<'a, S>
   ...
   pub(super) hub: &'a AdExchangeBuyer<S>,
   pub(super) _request: EditAllOrderDealsRequest,
   pub(super) _proposal_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct MarketplacenoteInsertCall<'a, S>
   ...
   pub(super) hub: &'a AdExchangeBuyer<S>,
   pub(super) _request: AddOrderNotesRequest,
   pub(super) _proposal_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct MarketplaceprivateauctionUpdateproposalCall<'a, S>
   ...
   pub(super) hub: &'a AdExchangeBuyer<S>,
   pub(super) _request: UpdatePrivateAuctionProposalRequest,
   pub(super) _private_auction_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct PerformanceReportListCall<'a, S>
   ...
   pub(super) hub: &'a AdExchangeBuyer<S>,
   pub(super) _account_id: i64,
   pub(super) _end_date_time: String,
   pub(super) _start_date_time: String,
   pub(super) _page_token: Option<String>,
   pub(super) _max_results: Option<u32>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct ProposalInsertCall<'a, S>
   ...
   pub(super) hub: &'a AdExchangeBuyer<S>,
   pub(super) _request: CreateOrdersRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
