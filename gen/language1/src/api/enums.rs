...
// region AnalyzeEntitySentimentRequestEncodingTypeEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
/// The encoding type used by the API to calculate offsets.
...
impl AsRef<str> for AnalyzeEntitySentimentRequestEncodingTypeEnum {
    fn as_ref(&self) -> &str {
        match *self {
...
impl std::convert::TryFrom< &str> for AnalyzeEntitySentimentRequestEncodingTypeEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "NONE" => Ok(AnalyzeEntitySentimentRequestEncodingTypeEnum::NONE),
           "UTF8" => Ok(AnalyzeEntitySentimentRequestEncodingTypeEnum::UTF8),
           "UTF16" => Ok(AnalyzeEntitySentimentRequestEncodingTypeEnum::UTF16),
           "UTF32" => Ok(AnalyzeEntitySentimentRequestEncodingTypeEnum::UTF32),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a AnalyzeEntitySentimentRequestEncodingTypeEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
// region ClassificationModelOptionsV2ModelContentCategoriesVersionEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
/// The content categories used for classification.
pub enum ClassificationModelOptionsV2ModelContentCategoriesVersionEnum {
    

    /// If `ContentCategoriesVersion` is not specified, this option will default to `V1`.
    ///
    /// "CONTENT_CATEGORIES_VERSION_UNSPECIFIED"
    #[serde(rename="CONTENT_CATEGORIES_VERSION_UNSPECIFIED")]
...
impl AsRef<str> for ClassificationModelOptionsV2ModelContentCategoriesVersionEnum {
    fn as_ref(&self) -> &str {
        match *self {
            ClassificationModelOptionsV2ModelContentCategoriesVersionEnum::CONTENTCATEGORIESVERSIONUNSPECIFIED => "CONTENT_CATEGORIES_VERSION_UNSPECIFIED",
            ClassificationModelOptionsV2ModelContentCategoriesVersionEnum::V1 => "V1",
            ClassificationModelOptionsV2ModelContentCategoriesVersionEnum::V2 => "V2",
        }
    }
}

impl std::convert::TryFrom< &str> for ClassificationModelOptionsV2ModelContentCategoriesVersionEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "CONTENT_CATEGORIES_VERSION_UNSPECIFIED" => Ok(ClassificationModelOptionsV2ModelContentCategoriesVersionEnum::CONTENTCATEGORIESVERSIONUNSPECIFIED),
           "V1" => Ok(ClassificationModelOptionsV2ModelContentCategoriesVersionEnum::V1),
           "V2" => Ok(ClassificationModelOptionsV2ModelContentCategoriesVersionEnum::V2),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a ClassificationModelOptionsV2ModelContentCategoriesVersionEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
impl std::convert::TryFrom< &str> for EntityTypeEnum {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           ...
           "PHONE_NUMBER" => Ok(EntityTypeEnum::PHONENUMBER),
           "ADDRESS" => Ok(EntityTypeEnum::ADDRESS),
           "DATE" => Ok(EntityTypeEnum::DATE),
           "NUMBER" => Ok(EntityTypeEnum::NUMBER),
           "PRICE" => Ok(EntityTypeEnum::PRICE),
            _=> Err(()),
        }
    }
}
