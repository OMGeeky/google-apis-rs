...
///              .app_filter_extensions("voluptua.")
///              .doit().await;
/// # }
/// ```
pub struct AppListCall<'a, S>
   ...
   pub(super) _app_filter_mime_types: Option<String>,
   pub(super) _app_filter_extensions: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ChangeGetStartPageTokenCall<'a, S>
   ...
   pub(super) hub: &'a DriveHub<S>,
   pub(super) _team_drive_id: Option<String>,
...
pub struct ChangeListCall<'a, S>
   ...
   pub(super) hub: &'a DriveHub<S>,
   pub(super) _page_token: String,
   pub(super) _team_drive_id: Option<String>,
   pub(super) _supports_team_drives: Option<bool>,
   pub(super) _supports_all_drives: Option<bool>,
   pub(super) _spaces: Option<String>,
   pub(super) _restrict_to_my_drive: Option<bool>,
   pub(super) _page_size: Option<i32>,
   pub(super) _include_team_drive_items: Option<bool>,
   pub(super) _include_removed: Option<bool>,
   ...
   pub(super) _include_corpus_removals: Option<bool>,
   pub(super) _drive_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct CommentListCall<'a, S>
   ...
   pub(super) hub: &'a DriveHub<S>,
   pub(super) _file_id: String,
   pub(super) _start_modified_time: Option<String>,
...
pub struct DriveCreateCall<'a, S>
   ...
   pub(super) hub: &'a DriveHub<S>,
   pub(super) _request: Drive,
   pub(super) _request_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct DriveDeleteCall<'a, S>
   ...
   pub(super) hub: &'a DriveHub<S>,
   pub(super) _drive_id: String,
   pub(super) _use_domain_admin_access: Option<bool>,
   pub(super) _allow_item_deletion: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct FileCopyCall<'a, S>
   ...
   pub(super) _keep_revision_forever: Option<bool>,
   pub(super) _include_permissions_for_view: Option<String>,
   pub(super) _include_labels: Option<String>,
   pub(super) _ignore_default_visibility: Option<bool>,
...
pub struct FileGenerateIdCall<'a, S>
   ...
   pub(super) _space: Option<String>,
...
pub struct FileModifyLabelCall<'a, S>
   ...
   pub(super) hub: &'a DriveHub<S>,
   pub(super) _request: ModifyLabelsRequest,
   pub(super) _file_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct FileUpdateCall<'a, S>
   ...
   pub(super) _supports_team_drives: Option<bool>,
   pub(super) _supports_all_drives: Option<bool>,
   pub(super) _remove_parents: Option<String>,
   pub(super) _ocr_language: Option<String>,
   pub(super) _keep_revision_forever: Option<bool>,
   pub(super) _include_permissions_for_view: Option<String>,
   pub(super) _include_labels: Option<String>,
   pub(super) _enforce_single_parent: Option<bool>,
   pub(super) _add_parents: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct PermissionCreateCall<'a, S>
   ...
   pub(super) hub: &'a DriveHub<S>,
   pub(super) _request: Permission,
   pub(super) _file_id: String,
   pub(super) _use_domain_admin_access: Option<bool>,
   pub(super) _transfer_ownership: Option<bool>,
   pub(super) _supports_team_drives: Option<bool>,
   pub(super) _supports_all_drives: Option<bool>,
   pub(super) _send_notification_email: Option<bool>,
   pub(super) _move_to_new_owners_root: Option<bool>,
   pub(super) _enforce_single_parent: Option<bool>,
   pub(super) _email_message: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct PermissionUpdateCall<'a, S>
   ...
   pub(super) _supports_team_drives: Option<bool>,
   pub(super) _supports_all_drives: Option<bool>,
   pub(super) _remove_expiration: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct TeamdriveDeleteCall<'a, S>
   ...
   pub(super) hub: &'a DriveHub<S>,
   pub(super) _team_drive_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
