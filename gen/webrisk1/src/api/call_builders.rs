...
///              .add_threat_types(&HashThreatTypesEnum::THREATTYPEUNSPECIFIED)
...
pub struct ProjectSubmissionCreateCall<'a, S>
   ...
   pub(super) hub: &'a WebRisk<S>,
   pub(super) _request: GoogleCloudWebriskV1Submission,
...
///              .threat_type(&ThreatListThreatTypeEnum::THREATTYPEUNSPECIFIED)
///              .add_constraints_supported_compressions(&ThreatListConstraintsSupportedCompressionsEnum::COMPRESSIONTYPEUNSPECIFIED)
///              .constraints_max_diff_entries(-20)
///              .constraints_max_database_entries(-55)
///              .doit().await;
/// # }
/// ```
...
///              .uri("gubergren")
///              .add_threat_types(&UriThreatTypesEnum::THREATTYPEUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
