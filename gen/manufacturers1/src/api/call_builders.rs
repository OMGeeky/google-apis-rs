...
/// # }
/// ```
pub struct AccountLanguageProductCertificationDeleteCall<'a, S>
    where S: 'a {
...
impl<'a, S> client::CallBuilder for AccountLanguageProductCertificationDeleteCall<'a, S> {}

impl<'a, S> AccountLanguageProductCertificationDeleteCall<'a, S>
where
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "manufacturers.accounts.languages.productCertifications.delete",
    ...
    pub fn name(mut self, new_value: &str) -> AccountLanguageProductCertificationDeleteCall<'a, S> {
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> AccountLanguageProductCertificationDeleteCall<'a, S> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> AccountLanguageProductCertificationDeleteCall<'a, S>
                                                        where T: AsRef<str> {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> AccountLanguageProductCertificationDeleteCall<'a, S>
                                                        where St: AsRef<str> {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AccountLanguageProductCertificationDeleteCall<'a, S>
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> AccountLanguageProductCertificationDeleteCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct AccountLanguageProductCertificationGetCall<'a, S>
    where S: 'a {
...
impl<'a, S> client::CallBuilder for AccountLanguageProductCertificationGetCall<'a, S> {}

impl<'a, S> AccountLanguageProductCertificationGetCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ProductCertification)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::{ToParts, url::Params};
        use std::borrow::Cow;
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "manufacturers.accounts.languages.productCertifications.get",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> AccountLanguageProductCertificationGetCall<'a, S> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> AccountLanguageProductCertificationGetCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> AccountLanguageProductCertificationGetCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountLanguageProductCertificationGetCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AccountLanguageProductCertificationGetCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountLanguageProductCertificationGetCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct AccountLanguageProductCertificationListCall<'a, S>
    where S: 'a {
...
impl<'a, S> client::CallBuilder for AccountLanguageProductCertificationListCall<'a, S> {}

impl<'a, S> AccountLanguageProductCertificationListCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListProductCertificationsResponse)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::{ToParts, url::Params};
        use std::borrow::Cow;
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "manufacturers.accounts.languages.productCertifications.list",
                               http_method: hyper::Method::GET });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> AccountLanguageProductCertificationListCall<'a, S> {
    ...
    pub fn page_token(mut self, new_value: &str) -> AccountLanguageProductCertificationListCall<'a, S> {
    ...
    pub fn page_size(mut self, new_value: i32) -> AccountLanguageProductCertificationListCall<'a, S> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> AccountLanguageProductCertificationListCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> AccountLanguageProductCertificationListCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountLanguageProductCertificationListCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AccountLanguageProductCertificationListCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountLanguageProductCertificationListCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct AccountLanguageProductCertificationPatchCall<'a, S>
    where S: 'a {

   pub(super) hub: &'a ManufacturerCenter<S>,
   pub(super) _request: ProductCertification,
   pub(super) _name: String,
...
impl<'a, S> client::CallBuilder for AccountLanguageProductCertificationPatchCall<'a, S> {}

impl<'a, S> AccountLanguageProductCertificationPatchCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ProductCertification)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "manufacturers.accounts.languages.productCertifications.patch",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: ProductCertification) -> AccountLanguageProductCertificationPatchCall<'a, S> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> AccountLanguageProductCertificationPatchCall<'a, S> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn update_mask(mut self, new_value: client::FieldMask) -> AccountLanguageProductCertificationPatchCall<'a, S> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> AccountLanguageProductCertificationPatchCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> AccountLanguageProductCertificationPatchCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountLanguageProductCertificationPatchCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AccountLanguageProductCertificationPatchCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountLanguageProductCertificationPatchCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
///              .add_include(&AccountIncludeEnum::UNKNOWN)
///              .doit().await;
/// # }
/// ```
