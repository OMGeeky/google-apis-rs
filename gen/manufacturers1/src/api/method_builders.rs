...
impl<'a, S> AccountMethods<'a, S> {
    ...
    pub fn languages_product_certifications_delete(&self, name: &str) -> AccountLanguageProductCertificationDeleteCall<'a, S> {
    ...
    pub fn languages_product_certifications_get(&self, name: &str) -> AccountLanguageProductCertificationGetCall<'a, S> {
    ...
    pub fn languages_product_certifications_list(&self, parent: &str) -> AccountLanguageProductCertificationListCall<'a, S> {
    ...
    pub fn languages_product_certifications_patch(&self, request: ProductCertification, name: &str) -> AccountLanguageProductCertificationPatchCall<'a, S> {
