...
pub struct Endpoint {
    ...
    pub forwarding_rule_target: Option<EndpointForwardingRuleTargetEnum>,
    ...
    pub load_balancer_type: Option<EndpointLoadBalancerTypeEnum>,
...
pub struct GoogleServiceInfo {
    ...
    pub google_service_type: Option<GoogleServiceInfoGoogleServiceTypeEnum>,
    /// Source IP address.
    #[serde(rename="sourceIp")]
...
pub struct LoadBalancerBackendInfo {
    ...
    pub health_check_firewalls_config_state: Option<LoadBalancerBackendInfoHealthCheckFirewallsConfigStateEnum>,
...
pub struct NatInfo {
    ...
    pub type_: Option<NatInfoTypeEnum>,
}
...
pub struct ProbingDetails {
    ...
    pub abort_cause: Option<ProbingDetailAbortCauseEnum>,
    ...
    pub result: Option<ProbingDetailResultEnum>,
...
pub struct RouteInfo {
    ...
    pub route_scope: Option<RouteInfoRouteScopeEnum>,
    /// Type of route.
