...
/// use networkmanagement1::api::enums::*;
/// # async fn dox() {
...
pub struct ProjectLocationGlobalConnectivityTestCreateCall<'a, S>
   ...
   pub(super) hub: &'a NetworkManagement<S>,
   pub(super) _request: ConnectivityTest,
   pub(super) _parent: String,
   pub(super) _test_id: Option<String>,
...
pub struct ProjectLocationGlobalConnectivityTestRerunCall<'a, S>
   ...
   pub(super) hub: &'a NetworkManagement<S>,
   pub(super) _request: RerunConnectivityTestRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
