...
pub struct ProjectLocationJobExecutionCancelCall<'a, S>
   ...
   pub(super) hub: &'a CloudRun<S>,
   pub(super) _request: GoogleCloudRunV2CancelExecutionRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
/// # }
/// ```
pub struct ProjectLocationJobExecutionExportStatusCall<'a, S>
    where S: 'a {
...
impl<'a, S> client::CallBuilder for ProjectLocationJobExecutionExportStatusCall<'a, S> {}

impl<'a, S> ProjectLocationJobExecutionExportStatusCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobExecutionExportStatusCall<'a, S> {
        self._name = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn operation_id(mut self, new_value: &str) -> ProjectLocationJobExecutionExportStatusCall<'a, S> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectLocationJobExecutionExportStatusCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobExecutionExportStatusCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationJobExecutionExportStatusCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationJobExecutionExportStatusCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationJobExecutionExportStatusCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
pub struct ProjectLocationJobCreateCall<'a, S>
   ...
   pub(super) hub: &'a CloudRun<S>,
   pub(super) _request: GoogleCloudRunV2Job,
   pub(super) _parent: String,
   pub(super) _validate_only: Option<bool>,
   pub(super) _job_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ProjectLocationJobRunCall<'a, S>
   ...
   pub(super) hub: &'a CloudRun<S>,
   pub(super) _request: GoogleCloudRunV2RunJobRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationOperationWaitCall<'a, S>
   ...
   pub(super) hub: &'a CloudRun<S>,
   pub(super) _request: GoogleLongrunningWaitOperationRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
/// # }
/// ```
pub struct ProjectLocationServiceRevisionExportStatusCall<'a, S>
    where S: 'a {
...
impl<'a, S> client::CallBuilder for ProjectLocationServiceRevisionExportStatusCall<'a, S> {}

impl<'a, S> ProjectLocationServiceRevisionExportStatusCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationServiceRevisionExportStatusCall<'a, S> {
        self._name = new_value.to_string();
        self
    }
    /// Required. The operation id returned from ExportImage.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn operation_id(mut self, new_value: &str) -> ProjectLocationServiceRevisionExportStatusCall<'a, S> {
        self._operation_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectLocationServiceRevisionExportStatusCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationServiceRevisionExportStatusCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationServiceRevisionExportStatusCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationServiceRevisionExportStatusCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationServiceRevisionExportStatusCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
pub struct ProjectLocationServiceCreateCall<'a, S>
   ...
   pub(super) hub: &'a CloudRun<S>,
   pub(super) _request: GoogleCloudRunV2Service,
   pub(super) _parent: String,
   pub(super) _validate_only: Option<bool>,
...
pub struct ProjectLocationExportImageCall<'a, S>
   ...
   pub(super) hub: &'a CloudRun<S>,
   pub(super) _request: GoogleCloudRunV2ExportImageRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
