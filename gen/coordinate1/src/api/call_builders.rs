...
pub struct JobInsertCall<'a, S>
   ...
   pub(super) _team_id: String,
   pub(super) _address: String,
   pub(super) _lat: f64,
   pub(super) _lng: f64,
   pub(super) _title: String,
   pub(super) _note: Option<String>,
   pub(super) _customer_phone_number: Option<String>,
   pub(super) _customer_name: Option<String>,
   pub(super) _custom_field: Vec<String>,
   pub(super) _assignee: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct JobListCall<'a, S>
   ...
   pub(super) _omit_job_changes: Option<bool>,
   pub(super) _min_modified_timestamp_ms: Option<u64>,
...
pub struct LocationListCall<'a, S>
   ...
   pub(super) hub: &'a Coordinate<S>,
   pub(super) _team_id: String,
   pub(super) _worker_email: String,
   pub(super) _start_timestamp_ms: u64,
   pub(super) _page_token: Option<String>,
   pub(super) _max_results: Option<u32>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct SchedulePatchCall<'a, S>
   ...
   pub(super) _team_id: String,
   pub(super) _job_id: u64,
   pub(super) _start_time: Option<u64>,
   pub(super) _end_time: Option<u64>,
   pub(super) _duration: Option<u64>,
   pub(super) _all_day: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct TeamListCall<'a, S>
   ...
   pub(super) hub: &'a Coordinate<S>,
   pub(super) _worker: Option<bool>,
   pub(super) _dispatcher: Option<bool>,
   pub(super) _admin: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
