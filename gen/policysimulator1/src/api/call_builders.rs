...
pub struct FolderLocationReplayCreateCall<'a, S>
   ...
   pub(super) hub: &'a PolicySimulator<S>,
   pub(super) _request: GoogleCloudPolicysimulatorV1Replay,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct OrganizationLocationOrgPolicyViolationsPreviewCreateCall<'a, S>
   ...
   pub(super) hub: &'a PolicySimulator<S>,
   pub(super) _request: GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreview,
   pub(super) _parent: String,
   pub(super) _org_policy_violations_preview_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
