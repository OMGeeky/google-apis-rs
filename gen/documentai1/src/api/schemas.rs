...
pub struct GoogleCloudDocumentaiV1HumanReviewStatus {
    ...
    pub state: Option<GoogleCloudDocumentaiV1HumanReviewStatusStateEnum>,
...
pub struct GoogleCloudDocumentaiV1ProcessorVersion {
    ...
    pub model_type: Option<GoogleCloudDocumentaiV1ProcessorVersionModelTypeEnum>,
...
pub struct GoogleCloudDocumentaiV1TrainProcessorVersionRequestCustomDocumentExtractionOptions {
    ...
    pub training_method: Option<GoogleCloudDocumentaiV1TrainProcessorVersionRequestCustomDocumentExtractionOptionTrainingMethodEnum>,
}
