...
pub struct EncodedFullHashGetCall<'a, S>
   ...
   pub(super) _encoded_request: Vec<u8>,
...
pub struct FullHashFindCall<'a, S>
   ...
   pub(super) hub: &'a Safebrowsing<S>,
   pub(super) _request: GoogleSecuritySafebrowsingV4FindFullHashesRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
...
pub struct ThreatHitCreateCall<'a, S>
   ...
   pub(super) hub: &'a Safebrowsing<S>,
   pub(super) _request: GoogleSecuritySafebrowsingV4ThreatHit,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
...
pub struct ThreatListUpdateFetchCall<'a, S>
   ...
   pub(super) hub: &'a Safebrowsing<S>,
   pub(super) _request: GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
...
pub struct ThreatMatchFindCall<'a, S>
   ...
   pub(super) hub: &'a Safebrowsing<S>,
   pub(super) _request: GoogleSecuritySafebrowsingV4FindThreatMatchesRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
