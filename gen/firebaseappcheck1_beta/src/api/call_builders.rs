...
pub struct ProjectServiceResourcePolicyBatchUpdateCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaBatchUpdateResourcePoliciesRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectServiceResourcePolicyCreateCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaResourcePolicy,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectVerifyAppCheckTokenCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaVerifyAppCheckTokenRequest,
