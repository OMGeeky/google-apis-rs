...
pub struct ActivationStatus {
    ...
    pub state: Option<ActivationStatusStateEnum>,
}
...
pub struct PassConstraints {
    ...
    pub nfc_constraint: Option<Vec<PassConstraintNfcConstraintEnum>>,
    /// The screenshot eligibility for the pass.
    #[serde(rename="screenshotEligibility")]
    
    pub screenshot_eligibility: Option<PassConstraintScreenshotEligibilityEnum>,
}
