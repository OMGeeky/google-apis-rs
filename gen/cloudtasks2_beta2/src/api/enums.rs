...
// region CancelLeaseRequestResponseViewEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
...
impl AsRef<str> for CancelLeaseRequestResponseViewEnum {
    fn as_ref(&self) -> &str {
        match *self {
...
impl std::convert::TryFrom< &str> for CancelLeaseRequestResponseViewEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "VIEW_UNSPECIFIED" => Ok(CancelLeaseRequestResponseViewEnum::VIEWUNSPECIFIED),
           "BASIC" => Ok(CancelLeaseRequestResponseViewEnum::BASIC),
           "FULL" => Ok(CancelLeaseRequestResponseViewEnum::FULL),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a CancelLeaseRequestResponseViewEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
// region LeaseTasksRequestResponseViewEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
/// The response_view specifies which subset of the Task will be returned. By default response_view is BASIC; not all information is retrieved by default because some data, such as payloads, might be desirable to return only when needed because of its large size or because of the sensitivity of data that it contains. Authorization for FULL requires `cloudtasks.tasks.fullView` [Google IAM](https://cloud.google.com/iam/) permission on the Task resource.
...
impl AsRef<str> for LeaseTasksRequestResponseViewEnum {
    fn as_ref(&self) -> &str {
        match *self {
...
impl std::convert::TryFrom< &str> for LeaseTasksRequestResponseViewEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "VIEW_UNSPECIFIED" => Ok(LeaseTasksRequestResponseViewEnum::VIEWUNSPECIFIED),
           "BASIC" => Ok(LeaseTasksRequestResponseViewEnum::BASIC),
           "FULL" => Ok(LeaseTasksRequestResponseViewEnum::FULL),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a LeaseTasksRequestResponseViewEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
...
// region RenewLeaseRequestResponseViewEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
/// The response_view specifies which subset of the Task will be returned. By default response_view is BASIC; not all information is retrieved by default because some data, such as payloads, might be desirable to return only when needed because of its large size or because of the sensitivity of data that it contains. Authorization for FULL requires `cloudtasks.tasks.fullView` [Google IAM](https://cloud.google.com/iam/) permission on the Task resource.
...
impl AsRef<str> for RenewLeaseRequestResponseViewEnum {
    fn as_ref(&self) -> &str {
        match *self {
...
impl std::convert::TryFrom< &str> for RenewLeaseRequestResponseViewEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "VIEW_UNSPECIFIED" => Ok(RenewLeaseRequestResponseViewEnum::VIEWUNSPECIFIED),
           "BASIC" => Ok(RenewLeaseRequestResponseViewEnum::BASIC),
           "FULL" => Ok(RenewLeaseRequestResponseViewEnum::FULL),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a RenewLeaseRequestResponseViewEnum {
    fn into(self) -> std::borrow::Cow<'a, str> {
        self.as_ref().into()
    }
}
