...
pub struct CalendarListInsertCall<'a, S>
   ...
   pub(super) hub: &'a CalendarHub<S>,
   pub(super) _request: CalendarListEntry,
   pub(super) _color_rgb_format: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
///              .show_deleted(false)
///              .page_token("amet.")
///              .min_access_role(&CalendarListMinAccessRoleEnum::FreeBusyReader)
///              .max_results(-17)
///              .doit().await;
/// # }
/// ```
...
///              .send_updates(&EventSendUpdatesEnum::All)
///              .send_notifications(false)
///              .doit().await;
/// # }
/// ```
...
pub struct EventGetCall<'a, S>
   ...
   pub(super) _calendar_id: String,
   pub(super) _event_id: String,
   pub(super) _time_zone: Option<String>,
   pub(super) _max_attendees: Option<i32>,
   pub(super) _always_include_email: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct EventInstanceCall<'a, S>
   ...
   pub(super) _event_id: String,
   pub(super) _time_zone: Option<String>,
   pub(super) _time_min: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
   pub(super) _time_max: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
   pub(super) _show_deleted: Option<bool>,
   pub(super) _page_token: Option<String>,
   pub(super) _original_start: Option<String>,
   pub(super) _max_results: Option<i32>,
   pub(super) _max_attendees: Option<i32>,
   pub(super) _always_include_email: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct EventListCall<'a, S>
   ...
   pub(super) hub: &'a CalendarHub<S>,
   pub(super) _calendar_id: String,
   pub(super) _updated_min: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
   pub(super) _time_zone: Option<String>,
   pub(super) _time_min: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
   pub(super) _time_max: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
   pub(super) _sync_token: Option<String>,
   pub(super) _single_events: Option<bool>,
   pub(super) _show_hidden_invitations: Option<bool>,
   pub(super) _show_deleted: Option<bool>,
   pub(super) _shared_extended_property: Vec<String>,
   ...
   pub(super) _event_types: Option<EventEventTypesEnum>,
   pub(super) _always_include_email: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Each appended value will retain its original ordering and be '/'-separated in the URL's parameters.
    pub fn add_event_types(mut self, new_value: &EventEventTypesEnum) -> EventListCall<'a, S> {
        self._event_types.push(new_value.clone());
        self
    }
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Append the given value to the *event types* query property.
    /// Each appended value will retain its original ordering and be '/'-separated in the URL's parameters.
    pub fn add_event_types(mut self, new_value: &EventEventTypesEnum) -> EventWatchCall<'a, S> {
        self._event_types.push(new_value.clone());
        self
    }
    /// Deprecated and ignored.
...
pub struct FreebusyQueryCall<'a, S>
   ...
   pub(super) hub: &'a CalendarHub<S>,
   pub(super) _request: FreeBusyRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
