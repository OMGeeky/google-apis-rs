...
///              .page_token("At")
///              .page_size(-8)
///              .content_type(&AssetContentTypeEnum::CONTENTTYPEUNSPECIFIED)
///              .add_asset_types("sed")
///              .doit().await;
/// # }
/// ```
...
///              .view(&MethodViewEnum::ANALYSISVIEWUNSPECIFIED)
...
///              .content_type(&MethodContentTypeEnum::CONTENTTYPEUNSPECIFIED)
