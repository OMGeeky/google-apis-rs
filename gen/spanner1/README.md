...
The [delegate trait](https://docs.rs/google-spanner1/5.0.5+20240418/google_spanner1/client::Delegate) is default-implemented, allowing you to customize it with minimal effort.
