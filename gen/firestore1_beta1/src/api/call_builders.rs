...
pub struct ProjectDatabaseIndexCreateCall<'a, S>
   ...
   pub(super) hub: &'a Firestore<S>,
   pub(super) _request: GoogleFirestoreAdminV1beta1Index,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectDatabaseExportDocumentCall<'a, S>
   ...
   pub(super) hub: &'a Firestore<S>,
   pub(super) _request: GoogleFirestoreAdminV1beta1ExportDocumentsRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectDatabaseImportDocumentCall<'a, S>
   ...
   pub(super) hub: &'a Firestore<S>,
   pub(super) _request: GoogleFirestoreAdminV1beta1ImportDocumentsRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
