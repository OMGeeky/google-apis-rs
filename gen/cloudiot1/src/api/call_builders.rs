...
pub struct ProjectLocationRegistryDeviceConfigVersionListCall<'a, S>
   ...
   pub(super) _num_versions: Option<i32>,
...
pub struct ProjectLocationRegistryDeviceStateListCall<'a, S>
   ...
   pub(super) hub: &'a CloudIot<S>,
   pub(super) _name: String,
   pub(super) _num_states: Option<i32>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
///              .page_token("duo")
///              .page_size(-55)
///              .gateway_list_options_gateway_type(&ProjectGatewayListOptionsGatewayTypeEnum::GATEWAYTYPEUNSPECIFIED)
...
pub struct ProjectLocationRegistryDeviceListCall<'a, S>
   ...
   pub(super) _field_mask: Option<client::FieldMask>,
   pub(super) _device_num_ids: Vec<u64>,
   pub(super) _device_ids: Vec<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ProjectLocationRegistryDeviceModifyCloudToDeviceConfigCall<'a, S>
   ...
   pub(super) hub: &'a CloudIot<S>,
   pub(super) _request: ModifyCloudToDeviceConfigRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationRegistryDeviceSendCommandToDeviceCall<'a, S>
   ...
   pub(super) hub: &'a CloudIot<S>,
   pub(super) _request: SendCommandToDeviceRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationRegistryBindDeviceToGatewayCall<'a, S>
   ...
   pub(super) hub: &'a CloudIot<S>,
   pub(super) _request: BindDeviceToGatewayRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationRegistryCreateCall<'a, S>
   ...
   pub(super) hub: &'a CloudIot<S>,
   pub(super) _request: DeviceRegistry,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationRegistryUnbindDeviceFromGatewayCall<'a, S>
   ...
   pub(super) hub: &'a CloudIot<S>,
   pub(super) _request: UnbindDeviceFromGatewayRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
