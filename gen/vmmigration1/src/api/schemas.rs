...
pub struct AzureSourceDetails {
    ...
    pub state: Option<AzureSourceDetailStateEnum>,
...
pub struct AzureSourceVmDetails {
    ...
    pub firmware: Option<AzureSourceVmDetailFirmwareEnum>,
    /// Output only. Information about VM capabilities needed for some Compute Engine features.
    #[serde(rename="vmCapabilitiesInfo")]
...
pub struct AzureVmDetails {
    ...
    pub boot_option: Option<AzureVmDetailBootOptionEnum>,
    /// The total size of the storage allocated to the VM in MB.
    #[serde(rename="committedStorageMb")]
    ...
    pub power_state: Option<AzureVmDetailPowerStateEnum>,
    /// The tags of the VM.
...
pub struct BootDiskDefaults {
    ...
    pub disk_type: Option<BootDiskDefaultDiskTypeEnum>,
...
pub struct Group {
    ...
    pub migration_target_type: Option<GroupMigrationTargetTypeEnum>,
...
pub struct ImageImportJob {
    ...
    pub state: Option<ImageImportJobStateEnum>,
...
pub struct ImageImportOsAdaptationParameters {
    ...
    pub license_type: Option<ImageImportOsAdaptationParameterLicenseTypeEnum>,
}
...
pub struct MigrationWarning {
    ...
    pub code: Option<MigrationWarningCodeEnum>,
...
pub struct PersistentDiskDefaults {
    ...
    pub disk_type: Option<PersistentDiskDefaultDiskTypeEnum>,
...
pub struct UpgradeStatus {
    ...
    pub state: Option<UpgradeStatusStateEnum>,
...
pub struct VmCapabilities {
    ...
    pub os_capabilities: Option<Vec<VmCapabilityOsCapabilitiesEnum>>,
}
...
pub struct VmwareSourceVmDetails {
    ...
    pub firmware: Option<VmwareSourceVmDetailFirmwareEnum>,
    /// Output only. Information about VM capabilities needed for some Compute Engine features.
    #[serde(rename="vmCapabilitiesInfo")]
