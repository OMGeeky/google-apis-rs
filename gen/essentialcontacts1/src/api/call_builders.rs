...
///              .page_token("voluptua.")
///              .page_size(-27)
///              .add_notification_categories(&FolderNotificationCategoriesEnum::NOTIFICATIONCATEGORYUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
...
pub struct FolderContactCreateCall<'a, S>
   ...
   pub(super) hub: &'a Essentialcontacts<S>,
   pub(super) _request: GoogleCloudEssentialcontactsV1Contact,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct FolderContactSendTestMessageCall<'a, S>
   ...
   pub(super) hub: &'a Essentialcontacts<S>,
   pub(super) _request: GoogleCloudEssentialcontactsV1SendTestMessageRequest,
...
///              .page_size(-75)
///              .add_notification_categories(&OrganizationNotificationCategoriesEnum::NOTIFICATIONCATEGORYUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
...
///              .page_token("gubergren")
///              .page_size(-16)
///              .add_notification_categories(&ProjectNotificationCategoriesEnum::NOTIFICATIONCATEGORYUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
