...
///              .view(&BlogViewEnum::VIEWTYPEUNSPECIFIED)
///              .max_posts(45)
///              .doit().await;
/// # }
/// ```
...
///              .view(&BlogViewEnum::VIEWTYPEUNSPECIFIED)
///              .add_status(&BlogStatusEnum::LIVE)
///              .add_role(&BlogRoleEnum::VIEWTYPEUNSPECIFIED)
...
///              .view(&CommentViewEnum::VIEWTYPEUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
...
///              .add_status(&CommentStatusEnum::LIVE)
///              .start_date("et")
///              .page_token("et")
///              .max_results(6)
///              .fetch_bodies(false)
...
///              .add_range(&PageViewRangeEnum::All)
///              .doit().await;
/// # }
/// ```
...
///              .view(&PageViewEnum::VIEWTYPEUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
...
///              .view(&PageViewEnum::VIEWTYPEUNSPECIFIED)
///              .add_status(&PageStatusEnum::LIVE)
...
///              .view(&PostUserInfoViewEnum::VIEWTYPEUNSPECIFIED)
///              .add_status(&PostUserInfoStatusEnum::LIVE)
///              .start_date("Lorem")
///              .page_token("est")
///              .order_by(&PostUserInfoOrderByEnum::ORDERBYUNSPECIFIED)
///              .max_results(71)
///              .labels("diam")
///              .fetch_bodies(true)
///              .end_date("et")
