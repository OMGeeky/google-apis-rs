...
impl<'a, S> Dfareporting<S> {
    ...
    pub fn new<A: 'static + client::GetToken>(client: hyper::Client<S, hyper::body::Body>, auth: A) -> Dfareporting<S> {
        Dfareporting {
            ...
            _base_url: "https://dfareporting.googleapis.com/dfareporting/v3.4/".to_string(),
    ...
    pub fn custom_events(&'a self) -> CustomEventMethods<'a, S> {
        CustomEventMethods { hub: &self }
    }
    ...
    /// It defaults to `https://dfareporting.googleapis.com/dfareporting/v3.4/`.
    ///
