...
pub struct AdvancedSecurityOverrides {
    ...
    pub mte_policy: Option<AdvancedSecurityOverrideMtePolicyEnum>,
...
pub struct ApplicationPolicy {
    ...
    pub credential_provider_policy: Option<ApplicationPolicyCredentialProviderPolicyEnum>,
...
pub struct ApplicationReport {
    ...
    pub user_facing_type: Option<ApplicationReportUserFacingTypeEnum>,
...
pub struct DeviceConnectivityManagement {
    ...
    pub configure_wifi: Option<DeviceConnectivityManagementConfigureWifiEnum>,
    /// Controls tethering settings. Based on the value set, the user is partially or fully disallowed from using different forms of tethering.
    #[serde(rename="tetheringSettings")]
    
    pub tethering_settings: Option<DeviceConnectivityManagementTetheringSettingsEnum>,
    ...
    pub usb_data_access: Option<DeviceConnectivityManagementUsbDataAccessEnum>,
    /// Controls configuring and using Wi-Fi direct settings. Supported on company-owned devices running Android 13 and above.
    #[serde(rename="wifiDirectSettings")]
    
    pub wifi_direct_settings: Option<DeviceConnectivityManagementWifiDirectSettingsEnum>,
}
...
pub struct DeviceRadioState {
    ...
    pub airplane_mode_state: Option<DeviceRadioStateAirplaneModeStateEnum>,
    /// Controls whether cellular 2G setting can be toggled by the user or not.
    #[serde(rename="cellularTwoGState")]
    
    pub cellular_two_g_state: Option<DeviceRadioStateCellularTwoGStateEnum>,
    ...
    pub minimum_wifi_security_level: Option<DeviceRadioStateMinimumWifiSecurityLevelEnum>,
    /// Controls the state of the ultra wideband setting and whether the user can toggle it on or off.
    #[serde(rename="ultraWidebandState")]
    
    pub ultra_wideband_state: Option<DeviceRadioStateUltraWidebandStateEnum>,
    /// Controls current state of Wi-Fi and if user can change its state.
    #[serde(rename="wifiState")]
    
    pub wifi_state: Option<DeviceRadioStateWifiStateEnum>,
}
...
pub struct InstallConstraint {
    ...
    pub charging_constraint: Option<InstallConstraintChargingConstraintEnum>,
    /// Optional. Device idle constraint.
    #[serde(rename="deviceIdleConstraint")]
    
    pub device_idle_constraint: Option<InstallConstraintDeviceIdleConstraintEnum>,
    /// Optional. Network type constraint.
    #[serde(rename="networkTypeConstraint")]
    
    pub network_type_constraint: Option<InstallConstraintNetworkTypeConstraintEnum>,
}
...
pub struct MigrationToken {
    ...
    pub management_mode: Option<MigrationTokenManagementModeEnum>,
...
pub struct Policy {
    ...
    pub credential_provider_policy_default: Option<PolicyCredentialProviderPolicyDefaultEnum>,
    ...
    pub printing_policy: Option<PolicyPrintingPolicyEnum>,
...
pub struct ProvisioningInfo {
    ...
    pub management_mode: Option<ProvisioningInfoManagementModeEnum>,
    /// MEID number of the CDMA device. For example, A00000292788E1.
    ...
    pub ownership: Option<ProvisioningInfoOwnershipEnum>,
    /// The device serial number.
    #[serde(rename="serialNumber")]
...
pub struct StartLostModeStatus {
    ...
    pub status: Option<StartLostModeStatusStatusEnum>,
}
...
pub struct StopLostModeStatus {
    ...
    pub status: Option<StopLostModeStatusStatusEnum>,
}
