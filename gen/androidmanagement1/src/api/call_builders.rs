...
///              .add_wipe_data_flags(&EnterpriseWipeDataFlagsEnum::WIPEDATAFLAGUNSPECIFIED)
///              .doit().await;
/// # }
/// ```
...
pub struct EnterpriseEnrollmentTokenCreateCall<'a, S>
   ...
   pub(super) hub: &'a AndroidManagement<S>,
   pub(super) _request: EnrollmentToken,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct EnterpriseMigrationTokenCreateCall<'a, S>
   ...
   pub(super) hub: &'a AndroidManagement<S>,
   pub(super) _request: MigrationToken,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct EnterpriseCreateCall<'a, S>
   ...
   pub(super) _signup_url_name: Option<String>,
   pub(super) _project_id: Option<String>,
   pub(super) _enterprise_token: Option<String>,
   pub(super) _agreement_accepted: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
///              .view(&EnterpriseViewEnum::ENTERPRISEVIEWUNSPECIFIED)
///              .project_id("et")
