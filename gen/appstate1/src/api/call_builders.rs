...
pub struct StateClearCall<'a, S>
   ...
   pub(super) _state_key: i32,
   pub(super) _current_data_version: Option<String>,
...
pub struct StateListCall<'a, S>
   ...
   pub(super) hub: &'a AppState<S>,
   pub(super) _include_data: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct StateUpdateCall<'a, S>
   ...
   pub(super) hub: &'a AppState<S>,
   pub(super) _request: UpdateRequest,
   pub(super) _state_key: i32,
   pub(super) _current_state_version: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
