...
pub struct ActionResultGetCall<'a, S>
   ...
   pub(super) _instance_name: String,
   pub(super) _hash: String,
   pub(super) _size_bytes: i64,
   pub(super) _inline_stdout: Option<bool>,
   pub(super) _inline_stderr: Option<bool>,
   pub(super) _inline_output_files: Vec<String>,
...
pub struct ActionResultUpdateCall<'a, S>
   ...
   pub(super) hub: &'a RemoteBuildExecution<S>,
   pub(super) _request: BuildBazelRemoteExecutionV2ActionResult,
   pub(super) _instance_name: String,
   pub(super) _hash: String,
   pub(super) _size_bytes: i64,
   pub(super) _results_cache_policy_priority: Option<i32>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ActionExecuteCall<'a, S>
   ...
   pub(super) hub: &'a RemoteBuildExecution<S>,
   pub(super) _request: BuildBazelRemoteExecutionV2ExecuteRequest,
   pub(super) _instance_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct BlobBatchReadCall<'a, S>
   ...
   pub(super) hub: &'a RemoteBuildExecution<S>,
   pub(super) _request: BuildBazelRemoteExecutionV2BatchReadBlobsRequest,
   pub(super) _instance_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct BlobBatchUpdateCall<'a, S>
   ...
   pub(super) hub: &'a RemoteBuildExecution<S>,
   pub(super) _request: BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest,
   pub(super) _instance_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct BlobFindMissingCall<'a, S>
   ...
   pub(super) hub: &'a RemoteBuildExecution<S>,
   pub(super) _request: BuildBazelRemoteExecutionV2FindMissingBlobsRequest,
   pub(super) _instance_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct OperationWaitExecutionCall<'a, S>
   ...
   pub(super) hub: &'a RemoteBuildExecution<S>,
   pub(super) _request: BuildBazelRemoteExecutionV2WaitExecutionRequest,
