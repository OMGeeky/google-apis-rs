...
pub struct SpreadsheetDeveloperMetadataSearchCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: SearchDeveloperMetadataRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct SpreadsheetSheetCopyToCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: CopySheetToAnotherSpreadsheetRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _sheet_id: i32,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct SpreadsheetValueBatchClearCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: BatchClearValuesRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct SpreadsheetValueBatchClearByDataFilterCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: BatchClearValuesByDataFilterRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
///              .value_render_option(&SpreadsheetValueRenderOptionEnum::FORMATTEDVALUE)
///              .add_ranges("ipsum")
///              .major_dimension(&SpreadsheetMajorDimensionEnum::DIMENSIONUNSPECIFIED)
///              .date_time_render_option(&SpreadsheetDateTimeRenderOptionEnum::SERIALNUMBER)
///              .doit().await;
/// # }
/// ```
...
pub struct SpreadsheetValueBatchGetByDataFilterCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: BatchGetValuesByDataFilterRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct SpreadsheetValueBatchUpdateCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: BatchUpdateValuesRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct SpreadsheetValueBatchUpdateByDataFilterCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: BatchUpdateValuesByDataFilterRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct SpreadsheetValueClearCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: ClearValuesRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _range: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct SpreadsheetBatchUpdateCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: BatchUpdateSpreadsheetRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct SpreadsheetCreateCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: Spreadsheet,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct SpreadsheetGetCall<'a, S>
   ...
   pub(super) _spreadsheet_id: String,
   pub(super) _ranges: Vec<String>,
   pub(super) _include_grid_data: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct SpreadsheetGetByDataFilterCall<'a, S>
   ...
   pub(super) hub: &'a Sheets<S>,
   pub(super) _request: GetSpreadsheetByDataFilterRequest,
   pub(super) _spreadsheet_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
