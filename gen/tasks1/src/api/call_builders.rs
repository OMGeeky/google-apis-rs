...
pub struct TaskInsertCall<'a, S>
   ...
   pub(super) _tasklist: String,
   pub(super) _previous: Option<String>,
...
pub struct TaskListCall<'a, S>
   ...
   pub(super) _show_completed: Option<bool>,
   pub(super) _page_token: Option<String>,
   pub(super) _max_results: Option<i32>,
   pub(super) _due_min: Option<String>,
   pub(super) _due_max: Option<String>,
   pub(super) _completed_min: Option<String>,
   pub(super) _completed_max: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
