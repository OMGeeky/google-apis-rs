...
// region GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum
#[derive(Clone, Copy, Eq, Hash, Debug, PartialEq, Serialize, Deserialize)]
/// Required. Specifies the target version of memcached engine to upgrade to.
pub enum GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum {
...
impl AsRef<str> for GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum {
    fn as_ref(&self) -> &str {
        match *self {
            GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum::MEMCACHEVERSIONUNSPECIFIED => "MEMCACHE_VERSION_UNSPECIFIED",
            GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum::MEMCACHE15 => "MEMCACHE_1_5",
            GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum::MEMCACHE1615 => "MEMCACHE_1_6_15",
        }
    }
}

impl std::convert::TryFrom< &str> for GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum {
    type Error = ();
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
           "MEMCACHE_VERSION_UNSPECIFIED" => Ok(GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum::MEMCACHEVERSIONUNSPECIFIED),
           "MEMCACHE_1_5" => Ok(GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum::MEMCACHE15),
           "MEMCACHE_1_6_15" => Ok(GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum::MEMCACHE1615),
            _=> Err(()),
        }
    }
}

impl<'a> Into<std::borrow::Cow<'a, str>> for &'a GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersionEnum {
